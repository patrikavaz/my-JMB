        ...
        96803: function(e, o, t) {
            ...
            var k = t(87930),
                ...
                C = (0, _.memo)(function(e) {
                    var o = e.name,
                        ...
                        L = Z[0],
                        S = Z[1],
                        M = _sliced_to_array((0, _.useState)(!1), 2),
                        I = M[0],
                        D = M[1],
                        ...
                        W = (null == t ? void 0 : t.length) > 1,
                        E = f.isPc && (null == t ? void 0 : t.length) > 1,
                        R = (0, _.useCallback)(function(e) {
                            !k && (T(!0), W && P(e.selectedScrollSnap()), E && (S(function() {
                        ...
                        U = (0, _.useCallback)(function(e) {
                            W && P(e.selectedScrollSnap()), E && (S(function() {
                                return e.canScrollNext()
                            }), D(function() {
                                return e.canScrollPrev()
                            }))
                    ...
                    (0, _.useEffect)(function() {
                        k || 1 !== (null == t ? void 0 : t.length) || T(!0)
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        children: [!B && !k && (0, r.jsx)(x.Z, {
                            ratio: Q
                        }), (0, r.jsxs)("div", {
                            className: (0, s.Z)(y()["banner-slider-discovery__content"], _define_property({}, y()["banner-slider-discovery__content--hidden"], !B && !k)),
                            ...
                            }), 1 === (null == t ? void 0 : t.length) && (0, r.jsx)(b, {
                                lazy: m,
                                sectionName: o,
                                banner: t[0],
                                metadata: n,
                ...
                return (0, _.useEffect)(function() {
                    if (!h) {
                        var e = new IntersectionObserver(function(o) {
                            _sliced_to_array(o, 1)[0].isIntersecting && (b(!0), e.disconnect())
                        }, {
                            rootMargin: c,
                            threshold: 0
                        });
            ...
            var E = function(e) {
                ...
                X = {
                    ...
                    top_reels_review_slider: R,
                    top_reels_business_slider: R,
                ...
                q = {
                    ...
                    horizontal_product_timely: W,
                    horizontal_product_popular: W,
                    horizontal_product_timely_basalam: W
                },
                F = t(1692),
                H = t(69064),
                Q = t(1822),
            ...
            function oe() {
                return (0, r.jsxs)(K(), {
                    className: V()["horizontal-product-timely-skeleton"],
                    children: [(0, r.jsxs)("div", {
                        className: V()["horizontal-product-timely-skeleton__header"],
                        children: [(0, r.jsx)("div", {
                            className: V()["horizontal-product-timely-skeleton__header-icon"],
                            children: (0, r.jsx)($(), {
                                className: V()["horizontal-product-timely-skeleton__icon"]
                            })
                        }), (0, r.jsxs)("div", {
                            className: V()["horizontal-product-timely-skeleton__header-content"],
                            children: [(0, r.jsx)($(), {
                                className: V()["horizontal-product-timely-skeleton__header-title"]
                            }), (0, r.jsx)($(), {
                                className: V()["horizontal-product-timely-skeleton__header-show-all"]
                            })]
                        })]
                    }), (0, r.jsxs)("div", {
                        className: V()["horizontal-product-timely-skeleton__items"],
                        children: [(0, r.jsx)(ee.Z, {
                            className: V()["horizontal-product-timely-skeleton__item"],
                            discountMode: !0
                        }), (0, r.jsx)(ee.Z, {
                            className: V()["horizontal-product-timely-skeleton__item"],
                            discountMode: !0
                    ...
                    children: s.map(function(e, n) {
                        ...
                        return (0, r.jsx)(M.Z, {
                            children: (0, r.jsxs)(S, {
                                ...
                                }), "top_reels_review_slider" === e.ui && (0, r.jsx)(P(), {
                                    children: (0, r.jsx)("div", {
                                        style: {
                                            display: i ? "block" : "none"
                                        },
                                ...
                                }), "top_reels_business_slider" === e.ui && (0, r.jsx)(P(), {
                                    children: (0, r.jsx)("div", {
                                        style: {
                                            display: i ? "block" : "none"
                                        },
        ...
        69064: function(e, o, t) {
            ...
            function _(e) {
                var o = e.hasLogo,
                    ...
                    y = void 0 !== k && k;
                return (0, r.jsxs)(s(), {
                    className: (0, n.Z)(l()["horizontal-product-popular-skeleton"], _define_property({}, l()["horizontal-product-popular-skeleton--with-percent-icon"], b)),
