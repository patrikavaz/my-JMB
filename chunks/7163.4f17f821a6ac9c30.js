    ...
    [7163], {
        57163: function(e, t, n) {
            ...
            var xr = "connected",
                ...
                ea = "add-event-listener",
                ta = "sender-chat-seen-all",
                na = "receiver-chat-seen-all",
                ra = "update-chat-list-by-id",
                aa = "update-last-seen-message",
                oa = "update-chat-list-by-socket",
                ia = "message.new.notify",
                sa = "chat.seen.notify",
                ca = "message.seen.notify",
                ua = "chat.last_seen.notify";
            ...
            function ka(e) {
                ...
                return f.useEffect(function() {
                    ...
                    height: "100%",
                    radius: a,
                    className: R.default(t, Na, _define_property({}, Ia, n))
                }) : null
            }
            ...
            var Aa = f.forwardRef(function(e, t) {
                    var n, r = e.className,
                        a = e.disabled,
                        o = e.onChange,
                        i = f.useRef(),
                    ...
                    return f.useImperativeHandle(t, function() {
                        ...
                        children: [_.jsx("div", {
                            ref: i,
                            className: La["contact-list-filter"],
                            children: _.jsx(X.default, {
                                className: R.default(La["contact-list-filter__btn"], _define_property({}, La["contact-list-filter__btn--active"], null !== d)),
                                icon: "bi-filter",
                                variant: "text",
                                color: "secondary",
                                size: "md",
                            ...
                            children: _.jsxs("div", {
                                className: La["contact-list-filter__dropdown"],
                                children: [_.jsxs("button", {
                                    className: La["contact-list-filter__dropdown-item"],
                                    onClick: function() {
                                        return g(null)
                                    },
                                    children: [_.jsx(G.default, {
                                        ...
                                        className: La["contact-list-filter__dropdown-title"],
                            ...
                            className: "dataset-inp-ChatListFilter",
                            children: _.jsxs("div", {
                                className: La["contact-list-filter__modal"],
                                children: [_.jsxs("button", {
                                    className: La["contact-list-filter__modal-item"],
                                    onClick: function() {
                                        return g(null)
                                    },
                                    children: [_.jsx(G.default, {
                                        ...
                                        className: La["contact-list-filter__modal-item-title"],
                                        children: "همه گفت‌و‌گوها"
                                    })]
                                }), _.jsxs("button", {
                                    className: La["contact-list-filter__modal-item"],
            ...
            function Pa(e) {
                ...
                return _.jsxs("div", {
                    className: R.default(a, Ra["contact-list-search"]),
                    children: [_.jsxs("div", {
                        className: R.default(Ra["contact-list-search__box"], (t = {}, _define_property(t, Ra["contact-list-search__box--focus"], b), _define_property(t, Ra["contact-list-search__box--disabled"], n), t)),
                        children: [_.jsx("i", {
                            className: R.default("bi-search", Ra["contact-list-search__box-icon"])
                        }), _.jsx("input", {
                            ref: s,
                            className: Ra["contact-list-search__box-input"],
                            type: "text",
                            placeholder: i,
                            value: l,
                            disabled: n,
                            ...
                            children: function(e) {
                                return _.jsx("button", {
                                    "aria-label": "بستن",
                                    className: Ra["contact-list-search__box-clear"],
                                    style: e,
                                    onClick: w,
                                    children: _.jsx("i", {
                                        className: "bi-close"
                        ...
                        className: R.default(Ra["contact-list-search__types"], _define_property({}, Ra["contact-list-search__types--show"], !!l)),
                        children: [_.jsx(G.default, {
                            className: Ra["contact-list-search__types-radio"],
                            label: "متن گفت‌وگوها",
                            value: "MESSAGES",
                            checked: "MESSAGES" === v,
                            onChange: g
            ...
            var Ja = f.memo(function(e) {
                    var t, n, r = e.className,
                        ...
                        u = i.featureFlags,
                        l = function() {
                            var e, t, n = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : Xa,
                                r = n.limit,
                                a = n.autoUpdate,
                                o = n.filterChannels,
                                                    ...
                                                    case 1:
                                                        return a = s.sent(), i = [], r.forEach(function(e) {
                                                            ...
                                                            if (delete t.message, e.chatType === Lr) {
                                                                ...
                                                                t.contact = _object_spread_props(_object_spread({}, Ma(t.contact)), {
                                                                    snippet: null === (r = e.contact) || void 0 === r ? void 0 : r.snippet,
                                                                    lastActivity: o || null
                                                                })
                                                            } else e.chatType === Ur ? t.contact = Fa(e.channel) : e.chatType === Or ? t.contact = Ba(e.group) : e.chatType === kr && (t.contact = Da(t.contact));
                                                            i.push(t)
                                                        ...
                                                        return e = n.sent(), R(function(n) {
                                                            ...
                                                            return t.chats.reverse().forEach(function(t) {
                                                                ...
                                                                if (-1 === n) {
                                                                    ...
                                                                    s.chatType === Lr ? s.contact = _object_spread_props(_object_spread({}, Ma(s.contact)), {
                                                                        lastActivity: (null == e ? void 0 : e[null === (a = t.contact) || void 0 === a ? void 0 : a.id]) || null
                                                                    }) : s.chatType === Ur ? s.contact = Fa(s.channel) : s.chatType === Or ? s.contact = Ba(s.group) : t.chatType === kr && (s.contact = Da(s.contact)), (null === (o = s.contact) || void 0 === o ? void 0 : o.identifier) === i && (s.unseenMessageCount = 0), r.unshift(s)
                                                                } else {
                                                                    var c, l = r[n];
                                                                    r.splice(n, 1);
                        ...
                        T = f.useCallback(function(e, t) {
                            ...
                            return _.jsx(H.default, {
                                value: t.contact.id,
                                className: "-n5vYh",
                                children: _.jsx(Oa, _object_spread({}, n))
                            })
                        }, []),
                        N = g.length > 0;
                    return _.jsxs("div", {
            ...
            function so(e) {
                var t, n;
                (arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : io).showToast && oo("مشکلی در انجام عملیات رخ داد. لطفا دوباره امتحان کنید."), n = null, (null == e ? void 0 : e.response) || (null == e ? void 0 : e.request) ? n = function(e) {
                    var t, n, r, a, o, i, s, c;
                    if (!(null == e ? void 0 : e.response) && !(null == e ? void 0 : e.request)) return e;
                    var u = new ao(e.response ? "Response error: " + (null == e || null === (t = e.response) || void 0 === t ? void 0 : t.statusText) : "Network error: " + (null == e ? void 0 : e.message));
            ...
            function co() {
                var e = _sliced_to_array(f.useState(""), 2),
                    ...
                    u = function() {
                        return fr(_a, arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {})
                    }(),
                    l = u.mutateAsync,
                    d = f.useRef(),
                                ...
                                switch (p.label) {
                                    ...
                                    case 3:
                                        return function(e, t) {
                                            try {
                                                var n, r;
                                                if (!(null == e || null === (n = e.response) || void 0 === n ? void 0 : n.data) || 500 === (null == e || null === (r = e.response) || void 0 === r ? void 0 : r.status)) return so(e);
                                                var a = e.response.data.error;
                                                a.messages ? a.messages.forEach(function(e) {
                                                    e.text && oo(s.replaceAllMatchedKeys(e.text, t))
                    ...
                    return {
                        ...
                        actions: {
                            ...
                            updateNotification: function(t) {
                                return e(function(e) {
                                    return {
                                        notification: uo(t, e.notification)
                                    }
                                })
                            },
                            updateUnseenMessageCount: function(t) {
                                return e(function(e) {
                                    return {
                                        unseenMessageCount: uo(t, e.unseenMessageCount)
                                    }
                                })
                            }
                        },
            ...
            var mo = "ppDI6t",
                ...
                Eo = "gIFjHm",
                So = "-kNcSq",
                jo = "object" == (void 0 === q ? "undefined" : _type_of(q)) && q && q.Object === Object && q,
                To = "object" == ("undefined" == typeof self ? "undefined" : _type_of(self)) && self && self.Object === Object && self,
                xo = jo || To || Function("return this")(),
                No = xo.Symbol,
                Io = Object.prototype,
                ...
                Ro = function(e) {
                    return null == e ? void 0 === e ? "[object Undefined]" : "[object Null]" : Ao && Ao in Object(e) ? function(e) {
                        var t = ko.call(e, Lo),
                            n = e[Lo];
                        try {
                            e[Lo] = void 0;
                        ...
                        var a = Oo.call(e);
                        return r && (t ? e[Lo] = n : delete e[Lo]), a
                    }(e) : Uo.call(e)
                },
                Po = function(e) {
                ...
                Mo = xo["__core-js_shared__"],
                Fo = (r = /[^.]+$/.exec(Mo && Mo.keys && Mo.keys.IE_PROTO || "")) ? "Symbol(src)_1." + r : "",
                Bo = Function.prototype.toString,
                Do = function(e) {
                    if (null != e) {
                        try {
                            return Bo.call(e)
                ...
                Ho = RegExp("^" + Go.call(Wo).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
                Vo = function(e, t) {
                    var n, r = null == e ? void 0 : e[t];
                    return !Po(n = r) || Fo && Fo in n || !(function(e) {
                        if (!Po(e)) return !1;
                        var t = Ro(e);
                        return "[object Function]" == t || "[object GeneratorFunction]" == t || "[object AsyncFunction]" == t || "[object Proxy]" == t
                    }(n) ? Ho : Xo).test(Do(n)) ? void 0 : r
                },
                qo = Vo(xo, "Map");
            Vo(Object, "create"),
                function() {
            ...
            Yo.hasOwnProperty, Yo.propertyIsEnumerable, null != (o = a = function() {
                return arguments
            }()) && "object" == (void 0 === o ? "undefined" : _type_of(o)) && Ro(a);
            var Ko = function() {
                return !1
            };
            Y(function(e, t) {
                var n = t && !t.nodeType && t,
                    r = n && e && !e.nodeType && e,
                    a = r && r.exports === n ? xo.Buffer : void 0,
                    o = (a ? a.isBuffer : void 0) || Ko;
                e.exports = o
            });
            var Jo = Y(function(e, t) {
                var n = t && !t.nodeType && t,
                    r = n && e && !e.nodeType && e,
                    a = r && r.exports === n && jo.process,
                    o = function() {
                        try {
            ...
            Jo && Jo.isTypedArray, Y(function(e, t) {
                var n = t && !t.nodeType && t,
                    r = n && e && !e.nodeType && e,
                    a = r && r.exports === n ? xo.Buffer : void 0,
            ...
            var Qo = Vo(xo, "DataView"),
                ...
                li = Do(ei),
                di = Ro;
            (Qo && di(new Qo(new ArrayBuffer(1))) != oi || qo && di(new qo) != ti || $o && di($o.resolve()) != ni || Zo && di(new Zo) != ri || ei && di(new ei) != ai) && (di = function(e) {
                var t = Ro(e),
            ...
            function _i(e) {
                var t = e.children,
                    ...
                    E = function() {
                        var e, t, n = function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "dalan-chat-broadcast-channel",
                                    ...
                                    S = f.useCallback(function() {
                                        ...
                                        try {
                                            ...
                                            r(o);
                                            var s = w();
                                            return C(s.isConnected, n), po(d.current, {
                                                leaderId: n,
                                                timestamp: Date.now(),
                                    ...
                                    T = f.useCallback(function(e) {
                                        return d.current ? po(d.current, _object_spread_props(_object_spread({}, e), {
                                            timestamp: Date.now(),
                                            fromClientId: _.current
                                            ...
                                            try {
                                                ...
                                                switch (n) {
                                                    ...
                                                    case "REQUEST_CONNECTION_STATUS":
                                                        var c = w();
                                                        c.leaderId === _.current && po(d.current, {
                                                            timestamp: Date.now(),
                                                            fromClientId: _.current,
                                                    ...
                                                    case "LEADER_VERIFICATION_REQUEST":
                                                        w().leaderId === _.current && po(d.current, {
                                                            timestamp: Date.now(),
                                                            leaderId: _.current,
                                                            fromClientId: _.current,
                                        ...
                                        var a = setInterval(P, 5e3),
                                            o = function() {
                                                try {
                                                    ...
                                                    var t = w();
                                                    t.leaderId === _.current && t.isConnected && (C(!1, null), po(d.current, {
                                                        isConnected: !1,
                                                        timestamp: Date.now(),
                                                        type: "CONNECTION_STATUS",
                                                        fromClientId: _.current
                            ...
                            T = function() {
                                ...
                                var u = f.useCallback(function(n) {
                                        var r, a = _object_spread_props(_object_spread({}, n), {
                                            contact: _object_spread({}, Ma(n.contact))
                                        });
                                        e(oa, a), e(Kr, a), (null === (r = c.current) || void 0 === r ? void 0 : r.enabled) && e($r, a), t(function(e) {
                                            return _object_spread_props(_object_spread({}, e), {
                                                chat: e.chat + 1
                                            })
                                        })
                                    ...
                                    d = f.useCallback(function(n) {
                                        ...
                                        }), (null === (a = s.current) || void 0 === a ? void 0 : a.id) === o && e(na, {
                                            chatId: o,
                                            seenAt: i,
                                            lastSeenId: u
                                        })) : e(ta, {
                            ...
                            k = function() {
                                return dr(["centrifuge-token"], pa, arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {})
                            }({
                                enabled: I && r
                            }),
                            L = k.data,
                        ...
                        var Y = f.useCallback(function() {
                            ...
                            Q = f.useCallback(function(e) {
                                ...
                                R(function(e) {
                                    ...
                                    t.type === vo.CHAT_PRIVATE_WARN.description && (n = _object_spread_props(_object_spread({}, n), _define_property({}, t.data.chat_id, _object_spread_props(_object_spread({}, t), {
                                        shouldShow: !0
                                    }))));
                                    try {
                                        s.bsLocalStorage.setItem(_o, JSON.stringify(_define_property({}, vo.CHAT_PRIVATE_WARN.description, _object_spread({}, n))))
                                    } catch (e) {
                                ...
                                t = l({
                                    ...
                                    callback: function(e) {
                                        R(function(t) {
                                            ...
                                            e.type === vo.CHAT_PRIVATE_WARN.description && (n = _object_spread_props(_object_spread({}, n), _define_property({}, e.data.chat_id, _object_spread_props(_object_spread({}, e), {
                                                shouldShow: !0
                                            }))));
                                            try {
                                                s.bsLocalStorage.setItem(_o, JSON.stringify(_define_property({}, vo.CHAT_PRIVATE_WARN.description, _object_spread({}, n))))
                ...
                f.useEffect(function() {
                    ...
                    function() {
                        dr(["unseen-messages-count"], va, arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {})
                    }({
                        enabled: !!h,
                        refetchInterval: 3e5,
                        onSuccess: function(e) {
            ...
            fi && fi.valueOf, Jo && Jo.isMap, Jo && Jo.isSet, t.O = function(e) {
                var t = e.user,
                    n = e.target,
                    r = e.children,
                    a = e.injection,
