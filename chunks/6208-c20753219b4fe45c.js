            ...
            function p() {
                ...
                return {
                    handleCreateVendorClickBtn: function() {
                        j ? r ? (0, f.Hr)(_.vendorDashboardUrl) : window.location.href = _.vendorDashboardUrl : (w("test_header_direct_login_to_vendor"), "indirect" === x ? ((0, s.s)("createVendorClick", {
                            location: "header"
