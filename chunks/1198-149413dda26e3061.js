...
function _ts_generator(t, e) {
    ...
    [1198], {
        71511: function(t, e, n) {
            ...
            function l() {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                return o.DZ.put("/web/v1/order/basket/address", (0, r.snakize)(t))
            }
        ...
        81918: function(t, e, n) {
            ...
            function b(t) {
                ...
                var D = (r || void 0 === window.BroadcastChannel || (r = new window.BroadcastChannel("bs_cart_summary_broadcast")), r);
                (0, p.useEffect)(function() {
                    if (D) {
                        var t = function(t) {
                            JSON.stringify(t.data.value) !== JSON.stringify(m.data) && h(t.data.value)
                        };
                ...
                }, [D, h, m.data]), (0, f.useEffectNoImmediate)(function() {
                    var t, e;
                    if (null === (t = m.data) || void 0 === t ? void 0 : t.lastItem) try {
                        var n = structuredClone(m.data);
                        null == D || null === (e = D.postMessage) || void 0 === e || e.call(D, {
                            value: n,
                            key: "update_cart_summary"
                        })
                    } catch (t) {
                        console.warn("Failed to serialize cart data for BroadcastChannel:", t)
                    }
        ...
        41581: function(t, e, n) {
            ...
            function f() {
                ...
                var _ = d(),
                    ...
                    h = null !== (u = null === (e = f.vendor) || void 0 === e ? void 0 : e.title) && void 0 !== u ? u : null === (n = f.vendor) || void 0 === n ? void 0 : n.name,
                    y = {
                        errors: [],
                        quantity: 1,
                        id: f.id,
                ...
                if (b && (y.price = b.price, y.product.stock = b.stock, y.product.price = b.price, y.product.primaryPrice = b.primaryPrice, y.variation = {
                        id: b.id,
                        stock: b.stock,
                        price: b.price,
