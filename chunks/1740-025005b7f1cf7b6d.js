    ...
    [1740], {
                            ...
                            return _async_to_generator(function() {
                                ...
                                return _ts_generator(this, function(n) {
                                    switch (n.label) {
                                        ...
                                        case 1:
                                            return n.sent(), (null == A ? void 0 : A.isBlocked) ? N("به علت نقض قوانین باسلام، دسترسی شما به استوری بسته شده. پیگیری بیشتر، با ثبت تیکت پشتیبانی.") : S ? (t = (0, g.Cw)(), null === (e = t.onCreateStoryClick) || void 0 === e || e.call(t, !0)) : null === (r = k.current) || void 0 === r || r.click(), [2]
                                    }
                                })
                            })()
                        };
                                        ...
                                        return _ts_generator(this, function(t) {
                                            switch (t.label) {
                                                case 0:
                                                    return [4, window.scheduler.yield()];
                                                case 1:
                                                    return t.sent(), W.stories.length > 0 ? D || (S && window.WebviewInterfaceVersion === g.gO.MOSTLY_WEBVIEW ? (r = (0, g.Cw)(), null === (e = r.onVendorStoryClick) || void 0 === e || e.call(r, JSON.stringify([(0, l.snakize)(_object_spread_props(_object_spread({}, W), {
                                                        is_followed: !0
                                                    }))]))) : Z(!0)) : G(), [2]
                                            }
                                        })
                                    ...
                                    return _ts_generator(this, function(u) {
                                        switch (u.label) {
                                            case 0:
                                                ...
                                                u.label = 1;
                                            case 1:
                                                return u.trys.push([1, 3, , 4]), i = P("در حال بررسی فایل"), [4, v(n)];
                                            case 2:
                                                return o = u.sent(), s = o.isValid, a = o.errorMessage, l = o.fileType, O(i), T(l), s ? (y(n), E(!0)) : N(a), [3, 4];
                                            case 3:
        ...
        56794: function(e, r, t) {
            ...
            function S(e) {
                var r = e.newUi,
                    ...
                    T = R[0],
                    V = R[1],
                    B = _sliced_to_array((0, w.useState)(null), 2),
                    A = B[0],
                    Y = B[1],
                    ...
                    re = (0, w.useCallback)(function(e) {
                        ...
                        Y(-1 === n ? null : t[n].user.id), F(-1 === i ? null : t[i].user.id), null == k || k(n)
                            ...
                            return _ts_generator(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return o.sent(), $ && window.WebviewInterfaceVersion === m.gO.MOSTLY_WEBVIEW ? (n = (0, m.Cw)(), i = [], null == t || t.forEach(function(e) {
                                            var r = _object_spread({}, e, e.user);
                                            Number.isNaN(Number(r.id)) || i.push(r)
                                        }), null === (r = n.onStoryClick) || void 0 === r || r.call(n, JSON.stringify((0, c.snakize)(i)), e)) : (re(e), L(!0), K(null)), [2]
                                }
                            })
                        })()
                            ...
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return e.sent(), null === A ? ne() : (re(A), K("first")), [2]
                                }
                            })
                        })()
                    }, [ne, A, re]),
                            ...
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return e.sent(), null !== W && (re(W), K(null)), [2]
                                }
                            })
                        })()
                    }, [W, re]),
                                        ...
                                        children: (0, n.jsx)("div", {
                                            ...
                                            children: (0, n.jsxs)("div", {
                                                ...
                                                children: ["STORY_SKELETON" === c.component && (0, n.jsx)(y.Z, {
                                                    ...
                                                    isLazy: l
                                                }), "DISCOVERY" === c.component && c.show && (0, n.jsx)(g.Z, {
                                                    onClick: ae
        ...
        64683: function(e, r, t) {
            ...
            function m(e) {
                var r, t, s = e.isLazy,
                    ...
                    y = void 0 !== u && u,
                    v = (0, _.b)().ua,
                    p = _sliced_to_array((0, l.useDisclosure)(), 2),
                    m = p[0],
                    w = p[1],
                    x = w.open,
                    j = w.close,
                    ...
                    N = k.isLoading;
                return (0, n.jsxs)("div", {
                    className: (0, i.Z)(c()["story-bar-reels"], _define_property({}, c()["story-bar-reels--new-ui"], y)),
                    onClick: function() {
                        return _async_to_generator(function() {
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                    ...
                    children: [(0, n.jsxs)("div", {
                        ...
                        children: [(0, n.jsx)(f(), {
                            size: (null == v ? void 0 : v.isPc) ? "96" : "72",
                            src: "https://statics.basalam.com/public-132/admin/7PQmB8/09-25/46CI8sY9xYZ0dJrMBlDZBTC7rcZU83FQMIdCTZa8IMQo5FfpIU.png",
                            storyStatus: "unseen",
                            lazy: a,
                            ...
                            label: "جدید",
                            size: (null == v ? void 0 : v.isPc) ? "md" : "sm",
                            variant: "fill",
                            className: c()["story-bar-reels__label"]
                        })]
                    }), (0, n.jsxs)("div", {
                        className: (0, i.Z)(c()["story-bar-reels__title"], _define_property({}, c()["story-bar-reels__title--isMobile"], !(null == v ? void 0 : v.isPc))),
                        children: [(0, n.jsx)("span", {
                            children: "ویدئوها"
                        }), (0, n.jsx)(b(), {
                            name: "bi-angle-left",
                        ...
                        isLoading: N,
                        currentContentIdOnClicked: (null == C || null === (r = C[null == S ? void 0 : S.current]) || void 0 === r ? void 0 : r.id) || (null == C || null === (t = C.at(0)) || void 0 === t ? void 0 : t.id),
            ...
            r.Z = (0, y.memo)(function() {
                var e, r, t, a = (0, u.b)(),
                    ...
                    z = (0, y.useCallback)(function(e) {
                        var r;
                        e > (null !== (r = null == E ? void 0 : E.length) && void 0 !== r ? r : 0) - 4 - 1 && p && !m && !I && h()
                    }, [null == E ? void 0 : E.length, p, h, m, I]);
        ...
        69511: function(e) {
            e.exports = {
                ...
                "story-bar-reels--new-ui": "_6tEV8",
                "story-bar-reels__main-avatar": "_0C9Jkj"
            }
        }
    }
]);