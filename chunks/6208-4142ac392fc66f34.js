...
function _ts_generator(e, t) {
    ...
    [6208], {
        ...
        42358: function(e, t, n) {
            ...
            function h(e, t) {
                return r.DZ.post("/web/v1/search/image/detect-boxes?confidence_threshold=0.01&max_boxes=4", e, {
                    signal: t,
                    timeout: 3e4
                })
            }
        ...
        55633: function(e, t, n) {
            ...
            function p() {
                var e, t = (0, l.Z)(),
                    ...
                    C = k.currentUser,
                    x = k.isVendor,
                    j = null === (e = b("test_header_direct_login_to_vendor", !1)) || void 0 === e ? void 0 : e.value,
                ...
                return {
                    handleCreateVendorClickBtn: function() {
                        x ? r ? (0, f.Hr)(_.vendorDashboardUrl) : window.location.href = _.vendorDashboardUrl : (w("test_header_direct_login_to_vendor"), "indirect" === j ? ((0, s.publishEvent)("createVendorClick", {
                            location: "header"
                        }), t.push("/landings/create-vendor")) : "direct" === j && (Z ? m("در حال حاضر امکان ساخت غرفه وجود ندارد.") : D ? I() : y({
                            callback: function() {
                                return I()
                            }
                        })))
        ...
        92518: function(e, t, n) {
            ...
            function _(e) {
                var t, n, a = e.user,
                    ...
                    x = _sliced_to_array((0, o.useState)(a.isFollowedByCurrentUser), 2),
                    j = x[0],
                    Z = x[1],
                    I = (0, d.Kn)(),
                    S = I.mutate,
                ...
                return (0, r.jsxs)("div", {
                    ...
                    }), a.name, a.id !== (null == k ? void 0 : k.id) && (!j && (null === (n = a.vendor) || void 0 === n ? void 0 : n.isActive) ? (0, r.jsx)(w(), {
                        size: "sm",
                        color: "secondary",
                        variant: "outline",
