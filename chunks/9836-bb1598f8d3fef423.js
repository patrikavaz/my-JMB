                                        ...
                                        return _async_to_generator(function() {
                                            ...
                                            return _ts_generator(this, function(n) {
                                                switch (n.label) {
                                                    ...
                                                    case 3:
                                                        n.sent(), (0, N.publishEvent)("updateProfile", {
                                                            email: a,
                                                            name: e.name,
                                                            userId: e.id
                                                        }), n.label = 4;
                                                    case 4:
                                                        return (0, N.publishEvent)("emailSubmited", {
                                                            email: a,
                                                            comesFrom: h.asPath
