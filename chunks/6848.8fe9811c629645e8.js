        ...
        16848: function(e, r, t) {
            ...
            function T() {
                var e, r, t, i = (0, d.b)().ua,
                    ...
                    Z = null == E || null === (e = E.variant) || void 0 === e ? void 0 : e.toLowerCase();
                (0, c.useEffect)(function() {
                    T(!0), A ? ((0, s.addClass)(document.body, "wb"), document.documentElement.style.setProperty("--top-banner-height", i.isMobile ? "48px" : "56px")) : document.documentElement.style.setProperty("--top-banner-height", "0px")
                }, [A, i.isMobile]);
                var R = (0, c.useMemo)(function() {
                    return _.X.has(m.pathname)
                }, [m.pathname]);
                return (null == E ? void 0 : E.show) && !R ? (0, n.jsx)("div", {
                    id: "urgent-sticky-note",
                    className: (0, o.Z)(u()["urgent-banner"], u()["urgent-banner--".concat(Z)], _define_property({}, u()["urgent-banner--hidden"], j)),
                    children: (0, n.jsxs)(b(), {
                        fluid: i.isMobile,
                        className: u()["urgent-banner__text"],
                        children: [(0, n.jsx)(h(), {
                            className: u()["urgent-banner__icon"],
                            name: null === (r = M[Z]) || void 0 === r ? void 0 : r.icon,
                            color: "var(--".concat(null === (t = M[Z]) || void 0 === t ? void 0 : t.color, ")")
            ...
            var n = t(32930),
                ...
                _ = function(e) {
                    var r = e.endTime,
                        ...
                        h = void 0 !== y && y,
                        p = (0, s.useRef)(),
                        v = _sliced_to_array((0, s.useState)(!1), 2),
                        g = v[0],
                        w = v[1],
                        M = (0, s.useMemo)(function() {
                            return (0, u.gregoryDate)()
                        }, []),
                        T = (0, s.useMemo)(function() {
                            return (0, u.gregoryDate)(r)
                        }, [r]),
                        k = (0, l.useIntersectionObserver)(),
                        x = k.isInViewport,
                        S = k.observe,
                        N = k.unobserve,
                        j = function(e) {
                            var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                                ...
                                l = (0, s.useRef)(e),
                                _ = (0, s.useRef)(i),
                                d = _sliced_to_array((0, s.useState)(c(e)), 2),
                                f = d[0],
                                m = d[1],
                                ...
                                y = (0, s.useCallback)(function() {
                                    l.current > 0 ? (l.current -= 1, _.current && m(c(l.current)), u.current = setTimeout(y, 1e3)) : 0 === l.current && (null == t || t())
                                }, [t]),
                                h = (0, s.useCallback)(function() {
                                    var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : e;
                                    clearTimeout(u.current), l.current = r, _.current && b(), u.current = setTimeout(y, 1e3)
                                }, [e, y, b]),
                                p = (0, s.useCallback)(function() {
                                    var r = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : e;
                                    clearTimeout(u.current), l.current = r, _.current && b(), h(r)
                                }, [e, h, b]);
                            return (0, s.useEffect)(function() {
                                var e = _.current;
                                _.current = i, !e && i && b()
                            }, [i, b]), (0, s.useEffect)(function() {
                                return o && h(e),
                                    function() {
                    ...
                    return (0, s.useEffect)(function() {
                        ...
                        ref: p,
                        className: (0, o.Z)([a, i().countdown, _define_property({}, i().colon, b)]),
                        children: C.map(function(e, r) {
                            return (0, n.jsx)("div", {
                                className: (0, o.Z)([i().countdown__item, _]),
                                children: e
                            }, r)
                        })
                    })
