    ...
    [1740], {
                            ...
                            return _async_to_generator(function() {
                                ...
                                return _ts_generator(this, function(n) {
                                    switch (n.label) {
                                        ...
                                        case 1:
                                            return n.sent(), (null == B ? void 0 : B.isBlocked) ? P("به علت نقض قوانین باسلام، دسترسی شما به استوری بسته شده. پیگیری بیشتر، با ثبت تیکت پشتیبانی.") : S ? (t = (0, m.Cw)(), null === (e = t.onCreateStoryClick) || void 0 === e || e.call(t, !0)) : null === (r = k.current) || void 0 === r || r.click(), [2]
                                    }
                                })
                            })()
                        };
                                    ...
                                    return _ts_generator(this, function(u) {
                                        switch (u.label) {
                                            case 0:
                                                ...
                                                u.label = 1;
                                            case 1:
                                                return u.trys.push([1, 3, , 4]), i = L("در حال بررسی فایل"), [4, v(n)];
                                            case 2:
        ...
        56794: function(e, r, t) {
            ...
            function S(e) {
                var r = e.newUi,
                    ...
                    l = void 0 !== a && a,
                    S = e.onStoryMutation,
                    k = e.comeFromHomePage,
                    C = e.onVisibleIndexChange,
                    P = (0, v.Z)(),
                    ...
                    Z = z[0],
                    U = z[1],
                    R = _sliced_to_array((0, w.useState)(r ? 126 : 97), 2),
                    T = R[0],
                    V = R[1],
                    ...
                    ee = (0, w.useCallback)(function(e) {
                        ...
                        A(-1 === n ? null : t[n].user.id), F(-1 === i ? null : t[i].user.id), null == C || C(n)
                    }, [null == t ? void 0 : t.length, C]),
                            ...
                            return _ts_generator(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return o.sent(), X && window.WebviewInterfaceVersion === g.gO.MOSTLY_WEBVIEW ? (n = (0, g.Cw)(), i = [], null == t || t.forEach(function(e) {
                                            var r = _object_spread({}, e, e.user);
                                            Number.isNaN(Number(r.id)) || i.push(r)
                                        }), null === (r = n.onStoryClick) || void 0 === r || r.call(n, JSON.stringify((0, c.snakize)(i)), e)) : (ee(e), N(!0), q(null)), [2]
                                }
                            })
                        })()
                    }, [ee, null == t ? void 0 : t.length, X]),
                            ...
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return e.sent(), null === B ? te() : (ee(B), q("first")), [2]
                                }
                            })
                        })()
                    }, [te, B, ee]),
                            ...
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return e.sent(), null !== W && (ee(W), q(null)), [2]
                                }
                            })
                        })()
                    }, [W, ee]),
                    oe = (0, w.useCallback)(function(e) {
                        null == C || C(e.activeIndex + e.slidesPerViewDynamic())
                    }, [C]),
                ...
                (0, w.useEffect)(function() {
                    var e, r = null === (e = J.current) || void 0 === e ? void 0 : e.swiper;
                    r && (null == C || C(r.activeIndex + r.slidesPerViewDynamic()))
                }, [C]);
                var le = (0, w.useRef)(null),
                    ue = (0, b.MG)({
                        isRtl: !0,
                        overscan: 1,
                        horizontal: !0,
                ...
                return (0, w.useEffect)(function() {
                    Z > 0 && ue.measure()
                }, [Z, ue]), (0, w.useLayoutEffect)(function() {
                    var e = function() {
                        U(r ? 96 : 80), V(r ? 126 : 97)
                    };
                    ...
                    children: s ? (0, n.jsx)(y.Z, {
                        ...
                        children: [H.isPc ? (0, n.jsx)(j, {
                            ...
                            children: (0, n.jsx)("div", {
                                ...
                                style: {
                                    width: "".concat(ue.getTotalSize(), "px")
                                },
                                children: ue.getVirtualItems().map(function(e) {
                                        ...
                                        children: (0, n.jsx)("div", {
                                            ...
                                            children: (0, n.jsxs)("div", {
                                                ...
                                                children: ["PUBLIC_STORY" === c.component && (0, n.jsx)(d.Z, {
                                                    isLazy: l,
                                                    onClick: null !== (s = c.onClick) && void 0 !== s ? s : re,
                                                    user: c,
                                                    newUi: r
                            ...
                            children: t.map(function(e) {
                                ...
                                return (0, n.jsxs)("div", {
                                    ...
                                    children: ["STORY_SKELETON" === e.component && (0, n.jsx)(y.Z, {
                                        ...
                                        isLazy: l,
                                        onClick: null !== (t = e.onClick) && void 0 !== t ? t : re,
                                        user: e,
                                        newUi: r
        ...
        91740: function(e, r, t) {
            ...
            var n = t(32930),
                ...
                d = t(87694),
                _ = t(27434);
            r.Z = (0, _.memo)(function(e) {
                var r, t, a, y = e.comeFromHomePage,
                    f = void 0 !== y && y,
                    v = (0, d.ml)(25),
                    b = v.hasNextPage,
                    p = v.fetchNextPage,
                    ...
                    g = v.isLoading,
                    w = (0, s.rv)().data,
                    x = (0, o.M_)(["isLoggedIn", "currentUser"]),
                    j = x.isLoggedIn,
                    S = x.currentUser,
                    k = _sliced_to_array((0, _.useState)(!1), 2),
                    C = k[0],
                    P = k[1],
                    L = (0, _.useRef)((0, c.isClientSide)() ? c.bsLocalStorage.getItem(u.S) : void 0),
                    O = h || L.current,
                    N = !C || !L.current && g,
                    I = (0, _.useMemo)(function() {
                        var e, r, t = null == O || null === (e = O.pages) || void 0 === e ? void 0 : e.flatMap(function(e) {
                        ...
                        }), j && (null == S || null === (r = S.vendor) || void 0 === r ? void 0 : r.isActive) && (null == t || t.splice(0, 0, {
                            show: !0,
                            component: "MY_STORY",
                            excludeFromNavigation: !0,
                            user: {
                        ...
                        })), (null == w ? void 0 : w.length) > 0 && (null == t || t.splice(function() {
                            var e, r = null == t ? void 0 : t.findIndex(function(e) {
                                var r;
                                return 68565 === (null == e || null === (r = e.user) || void 0 === r ? void 0 : r.id)
                            });
                            return r >= 0 ? r + 1 : j && (null == S || null === (e = S.vendor) || void 0 === e ? void 0 : e.isActive) ? 1 : 0
                        }(), 0, {
                            show: !0,
                            component: "REELS",
                            excludeFromNavigation: !0,
                    ...
                    }, [N, j, null == O || null === (r = O.pages) || void 0 === r ? void 0 : r.length, null == S || null === (t = S.vendor) || void 0 === t ? void 0 : t.isActive, null == w ? void 0 : w.length]),
                    M = (0, d.NS)(),
                    E = (0, _.useCallback)(function(e) {
                        var r;
                        e > (null !== (r = null == I ? void 0 : I.length) && void 0 !== r ? r : 0) - 4 - 1 && b && !m && !N && p()
                    }, [null == I ? void 0 : I.length, b, p, m, N]);
                if ((0, _.useEffect)(function() {
                        if (O && !(null == O ? void 0 : O.cached) && !(0, c.isServerSide)()) {
                            var e = function() {
                                c.bsLocalStorage.setItem(u.S, _object_spread_props(_object_spread({}, O), {
                                    cached: !0
                                }), 1440)
                            };
                    ...
                    }, [O]), (0, _.useEffect)(function() {
                        P(!0)
                    }, []), N || void 0 !== I && 0 !== I.length || (null == S || null === (a = S.vendor) || void 0 === a ? void 0 : a.isActive)) return (0, n.jsx)(l(), {
                    children: (0, n.jsx)("div", {
                        "data-from": "home",
