                                ...
                                if (r) {
                                    ...
                                    if (r.version === u.gO.PARTIAL_WEBVIEW) window.location.href = "".concat(c.customerPrefix, "://conversation/").concat(t);
                                        ...
                                        var d = e.hasProductForWebview,
                                            ...
                                            S = d.status;
                                        null === (a = r.openLink) || void 0 === a || a.call(r, "".concat(o.baseUrl, "/account/chats/").concat(t, "?client=app&screen.type=native&productPrimaryPrice=").concat(l, "&productPrice=").concat(p, "&productName=").concat(f, "&productPicture=").concat(h, "&productId=").concat(b, "&userId=").concat(_, "&vendorId=").concat(v, "&productRating=").concat(g, "&productInventory=").concat(m, "&productReviewCount=").concat(y, "&vendorTitle=").concat(w, "&canAddToCart=").concat(I, "&vendorCityName=").concat(k, "&vendorIdentifier=").concat(j, "&productStatus=").concat(S))
                                    } else null === (s = r.openLink) || void 0 === s || s.call(r, "".concat(o.baseUrl, "/account/chats/").concat(t, "?client=app&screen.type=native"))
                                } else {
                                    var T = e || {};
                                    T.hasProductForWebview;
                                    n(t, _object_without_properties(T, ["hasProductForWebview"]))
                                }
                            }(e, n, t.openChatModal)
                        }
                    })
