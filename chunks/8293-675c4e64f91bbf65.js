            ...
            var p = {
                ...
                v = function(e) {
                    var t = e.show,
                        ...
                        D = function() {
                            L || (N.current && clearTimeout(N.current), N.current = setTimeout(function() {
                                void 0 === t && P(!0)
                            }, v))
                        },
                        ...
                        H = d.useCallback(function() {
                            setTimeout(function() {
                                if (M && C.current && S.current) {
                                    var e = C.current.getBoundingClientRect(),
                                        t = !0,
                                        n = C.current.offsetWidth / 2,
                                        o = S.current.offsetWidth / 2,
                                        r = e.left + n - o,
                                        i = e.top - S.current.offsetHeight - 10;
                                    r < 5 ? r = 5 : r + S.current.offsetWidth > window.innerWidth - 20 && (r = window.innerWidth - S.current.offsetWidth - 20), i < 5 && (i = e.top + C.current.offsetHeight + 10, t = !1), S.current.style.top = "".concat(i, "px"), S.current.style.left = "".concat(r, "px"), S.current.style.zIndex = l.popupManager.getNewZIndex().toString(), S.current.dataset.bsTooltipTop = "".concat(t);
                                    var s = S.current.getBoundingClientRect(),
                        ...
                        B = d.useCallback(function() {
                            "undefined" != typeof document && (M ? (y.onTooltipVisible(), H(), _ && Y(), window.addEventListener("scroll", H)) : window.removeEventListener("scroll", H))
                        }, [M, _, H, y, Y]);
                    return d.useEffect(function() {
                        return y.init(), W.init(z),
                            function() {
                                "undefined" != typeof window && (y.destroy(), W.destroy(), window.removeEventListener("scroll", H), N.current && clearTimeout(N.current), R.current && clearTimeout(R.current))
                            }
                    }, []), d.useEffect(function() {
                        B()
                    }, [M]), i.jsxs("div", {
                        className: s.clsx("bs-tooltip-wrapper", {
                            "bs-tooltip-wrapper--disabled": L
                        }, c),
                        onMouseOver: D,
                        onFocus: D,
                        onTouchStart: D,
