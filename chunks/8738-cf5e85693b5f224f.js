...
function _ts_generator(e, t) {
    ...
    [8738], {
        2347: function(e, t, r) {
            ...
            function l(e) {
                var t = e.href,
                    ...
                    S = function(e) {
                        if (!f.current && !o) {
                            if (y === b.asPath) return void(null == l || l(e));
                            f.current = !0, j(e)
                        }
                    };
                        ...
                        return _async_to_generator(function() {
                            ...
                            return _ts_generator(this, function(c) {
                                switch (c.label) {
                                    ...
                                    case 1:
                                        return c.sent(), !w && (null === (r = window) || void 0 === r || null === (t = r.Eitaa) || void 0 === t ? void 0 : t.WebApp) && (null === (a = window) || void 0 === a || null === (o = a.Eitaa) || void 0 === o || null === (n = o.WebApp) || void 0 === n || n.openLink(y, {
                                            try_browser: !0
                                        })), S(e), [2]
                                }
                            })
            ...
            function y(e) {
                ...
                var D = function() {
                    ...
                    R = (0, b.useCallback)(function(e) {
                        ...
                        return null
                    }, [null == F ? void 0 : F.current, P, O, g, m.isPc, w.asPath, h, j]),
        ...
        61262: function(e, t, r) {
            ...
            function _() {
                var e = (0, l.useDalanActions)();
                return {
                    authForm: _object_spread({}, (0, d.qq)()),
                    auth: _object_spread({}, (0, n.WX)(), (0, p.X$)()),
                    dalan: _object_spread_props(_object_spread({}, e), {
                        openChatModal: function(t, r) {
                            return function(e, t, r) {
                                var n = a()().publicRuntimeConfig;
                                if (i()()) {
                                    var o, c, l = (0, s.Cw)();
                                    if (l)
                                        if (l.version === s.gO.PARTIAL_WEBVIEW) window.location.href = "".concat(u.customerPrefix, "://conversation/").concat(e);
                                        else if (null == t ? void 0 : t.hasProductForWebview) {
                                        var p = t.hasProductForWebview,
                                            d = p.primaryPrice,
                                            _ = p.price,
                                            f = p.title,
                                            b = p.vendorId,
                                            ...
                                            S = p.canAddToCart,
                                            k = p.vendorCityName,
                                            C = p.vendorIdentifier,
                                            O = p.status,
                                            P = p.hasVariation;
                                        null === (o = l.openLink) || void 0 === o || o.call(l, "".concat(n.baseUrl, "/account/chats/").concat(e, "?client=app&screen.type=native&productPrimaryPrice=").concat(d, "&productPrice=").concat(_, "&productName=").concat(f, "&productPicture=").concat(v, "&productId=").concat(w, "&userId=").concat(h, "&vendorId=").concat(b, "&productRating=").concat(y, "&productInventory=").concat(g, "&productReviewCount=").concat(m, "&vendorTitle=").concat(j, "&canAddToCart=").concat(S, "&vendorCityName=").concat(k, "&vendorIdentifier=").concat(C, "&productStatus=").concat(O, "&productHasVariation=").concat(P))
                                    } else null === (c = l.openLink) || void 0 === c || c.call(l, "".concat(n.baseUrl, "/account/chats/").concat(e, "?client=app&screen.type=native"))
                                } else {
                                    var I = t || {};
                                    I.hasProductForWebview;
                                    r(e, _object_without_properties(I, ["hasProductForWebview"]))
                                }
                            }(t, r, e.openChatModal)
                        }
                    })
