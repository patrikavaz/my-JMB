    ...
    [7314], {
        58507: function(e, t, r) {
            ...
            var a = r(32930),
                ...
                y = r.n(p),
                v = {
                    src: "/charsou-assets/3.45.27/_next/static/media/header-logotype.5b1447ff.svg"
                },
                j = r(43114),
                x = r(28030),
                g = r(2389),
            ...
            function F() {
                ...
                return (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsx)("div", {
                        className: O()["search__header-icon"],
                        children: (0, a.jsx)("i", {
            ...
            function q(e) {
                var t, o, d = e.className,
                    ...
                    p = (0, c.l)().getFeatureValue,
                    g = (0, I.N)(),
                    w = g.getSearchTypeByKey,
                    k = g.getSearchTypeByPath,
                    C = _sliced_to_array((0, u.useState)(!1), 2),
                    N = C[0],
                    O = C[1],
                    S = _sliced_to_array((0, u.useState)(!1), 2),
                    T = S[0],
                    P = S[1],
                    Z = (0, u.useMemo)(function() {
                        return "yes" === p("image_search")
                    }, [p]),
                ...
                return (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsx)(x.Z, {
                        ...
                        }), Z && (0, a.jsx)(F, {}), (null === (o = h.query) || void 0 === o ? void 0 : o.q) && (0, a.jsxs)("button", {
        ...
        37314: function(e, t, r) {
            ...
            function b(e) {
                var t = e.title,
                    ...
                    w = g.isWebview,
                    k = g.ua,
                    C = (0, _.Kp)(["isIosApp"]).isIosApp,
                    N = (0, f.useRef)(),
                    O = _sliced_to_array((0, f.useState)(58), 2),
                    S = O[0],
                    T = O[1],
                    P = (0, f.useMemo)(function() {
                        return !!r || C && !m.w.includes(x.pathname)
                    }, [x.pathname, r, C]);
                return (0, f.useEffect)(function() {
                    c.Z.init(s(), w || k.isIOS ? "static" : "dynamic")
                }, [w, k]), (0, f.useEffect)(function() {
                    var e;
                    ...
                    children: [(0, a.jsx)("div", {
                        ...
                        className: s()["header-placeholder"]
                    }), (0, a.jsxs)("header", {
                        className: (0, n.Z)(s().header, _define_property({}, s()["header--not-bordered"], j)),
                        id: "header",
                        ref: N,
                        children: [(0, a.jsxs)("div", {
                            className: (0, n.Z)(s()["header-body"], i),
                            children: [y, P && (0, a.jsx)("button", {
                                className: s()["header-body__back"],
                                onClick: function() {
                                    r ? r() : x.back()
                                },
                                "aria-label": "برگشت",
                                ...
                                className: s()["header-body__title"],
                                children: t
                            }), v && (0, a.jsx)(h.Z, {}), o && (0, a.jsx)(l(), {
                                display: "flex",
                                alignItems: "center",
                                justifyContent: "flex-end",
                                className: s()["header-body__actions"],
                                children: null == o ? void 0 : o.map(function(e, t) {
                                    return (0, a.jsx)("button", _object_spread_props(_object_spread({
                                        className: s()["header-body__actions-btn"],
                                        onClick: e.onClick,
            ...
            b.displayName = "HeaderMobile", t.default = (0, f.memo)(b)
        },
        28030: function(e, t, r) {
            ...
            function N(e) {
                var t = e.show,
                    ...
                    x = (0, w.useRef)(null),
                    N = (0, w.useRef)(null),
                    O = _sliced_to_array((0, w.useState)(""), 2),
                    S = O[0],
                    T = O[1],
                    P = _sliced_to_array((0, w.useState)(!0), 2),
                    Z = P[0],
                    E = P[1],
                    F = _sliced_to_array((0, w.useState)(!1), 2),
                    I = F[0],
                    q = F[1],
                    M = _sliced_to_array((0, w.useState)(null), 2),
                    A = M[0],
                    R = M[1],
                    V = (0, c.useEmitter)(),
                    B = V.subEvent,
                ...
                (0, w.useEffect)(function() {
                    ...
                    var r = 0;
                    return function t() {
                            (!p.current || document.activeElement !== p.current) && (r += 1, p.current && document.activeElement !== p.current ? (p.current.focus(), document.activeElement !== p.current && r < 20 && (e = setTimeout(t, 100))) : r < 20 && (e = setTimeout(t, 100)))
                        }(),
                        function() {
                ...
                var T = (0, l.useMemo)(function() {
                    ...
                    P = (0, l.useCallback)(function(e, t) {
                        var r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                            ...
                            b = t || m;
                        c && (b = "/cat/".concat(u).concat(c ? "/".concat(c) : "")), o && !s && (b = "/".concat(o)), "/account/vendor" === h.pathname && (b = "/account/vendor");
                        var p = _ ? r ? f : _object_spread_props(_object_spread({}, l, f), {
                                page: d
                            }) : _object_spread({}, N, f),
                            y = JSON.parse(JSON.stringify(p, function(e, t) {
                                return "" === t ? void 0 : t
                            }));
                        _ ? h.push(b + (0, n.stringifyQuery)(y)) : O(y)
                    }, [h.asPath, N]),
