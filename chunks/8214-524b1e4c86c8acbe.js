    ...
    [8214], {
        2347: function(t, e, n) {
            ...
            function d(t) {
                        ...
                        return _async_to_generator(function() {
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    ...
                                    case 1:
                                        return y(), [4, window.scheduler.yield()];
                                    case 2:
                ...
                return (0, r.jsx)(w, _object_spread_props(_object_spread({
                    href: m,
                    onClick: function(t) {
                        return _async_to_generator(function() {
                            return _ts_generator(this, function(e) {
        ...
        71511: function(t, e, n) {
            ...
            function y(t) {
                var e = t.body,
                    ...
                    i = t.config,
                    c = void 0 === i ? {} : i;
                return o.DZ.post("/web/v1/order/basket/coupon", (0, r.snakize)(n), c)
            }
        ...
        81918: function(t, e, n) {
            ...
            function h(t) {
                var e = t.children,
                    ...
                    y = (0, v.useCallback)(function(t) {
                        c.bsSessionStorage.setItem("cart_coupon", t)
                    }, []);
                (0, v.useEffect)(function() {
                    n.query.coupon && y(n.query.coupon)
                }, []);
                var k = (r || "undefined" == typeof BroadcastChannel || (r = new BroadcastChannel("bs_cart_summary_broadcast")), r);
                k && (k.onmessage = function(t) {
                    JSON.stringify(t.data.value) !== JSON.stringify(g.data) && m(t.data.value)
                }), (0, f.useEffectNoImmediate)(function() {
                    var t, e;
                    (null === (t = g.data) || void 0 === t ? void 0 : t.lastItem) && (null == k || null === (e = k.postMessage) || void 0 === e || e.call(k, {
                                ...
                                if (r) {
                                    ...
                                    if (r.version === u.gO.PARTIAL_WEBVIEW) window.location.href = "".concat(c.customerPrefix, "://conversation/").concat(t);
                                        ...
                                        var d = e.hasProductForWebview,
                                            ...
                                            S = d.status,
                                            T = d.hasVariation;
                                        null === (a = r.openLink) || void 0 === a || a.call(r, "".concat(o.baseUrl, "/account/chats/").concat(t, "?client=app&screen.type=native&productPrimaryPrice=").concat(l, "&productPrice=").concat(p, "&productName=").concat(f, "&productPicture=").concat(h, "&productId=").concat(b, "&userId=").concat(_, "&vendorId=").concat(v, "&productRating=").concat(g, "&productInventory=").concat(m, "&productReviewCount=").concat(w, "&vendorTitle=").concat(y, "&canAddToCart=").concat(k, "&vendorCityName=").concat(I, "&vendorIdentifier=").concat(j, "&productStatus=").concat(S, "&productHasVariation=").concat(T))
