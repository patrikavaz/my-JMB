            ...
            var l = {
                ...
                c = function(e) {
                    ...
                    return a.useEffect(function() {
                        ...
                        onClick: u,
                        className: r.clsx("bs-avatar bs-avatar--".concat(s, " bs-avatar--").concat(h), d),
                        children: ["none" !== h && o.jsxs("svg", {
                            className: "bs-avatar__story-ring",
                            children: [o.jsxs("linearGradient", {
                                id: "".concat(h, "-").concat(_),
                                x1: "0",
                                y1: "0",
                                x2: "1",
                                y2: "1",
        ...
        56855: function(e, t, n) {
            ...
            var o = n(32930),
                ...
                s = {
                    ...
                    variant: i.oneOf(["fill", "text"]),
                    label: i.oneOfType([i.string, i.number]).isRequired,
                    color: i.oneOf(["primary", "black", "green", "blue", "dark-blue", "red", "yellow"])
                },
                a = function(e) {
                    var t = e.icon,
                        n = e.label,
                    ...
                    return o.jsxs("span", {
                        className: r.clsx(i, "bs-label", "bs-label--".concat(f, "-").concat(d), "bs-label--".concat(a), {
                            "bs-label--disabled": c
                        }),
                        children: [t && o.jsx("i", {
            ...
            a.propTypes = s, a.displayName = "BsLabel", e.exports = a
        },
        70437: function(e, t, n) {
            ...
            var o = n(32930),
                ...
                l = {
                    ...
                    radius: a.oneOfType([a.string, a.number]),
                ...
                u = function(e) {
                    var t = e.width,
                        ...
                        u = void 0 === l ? 4 : l,
                        d = e.waveColor,
                        p = void 0 === d ? "var(--gray-100)" : d,
                        f = e.backgroundColor,
                        m = void 0 === f ? "var(--gray-050)" : f,
                        h = i.useRef(null),
                        y = s.useIntersectionObserver(),
                        v = y.observe,
                        b = y.unobserve,
                        g = y.isInViewport,
                        _ = {
                    ...
                    return i.useEffect(function() {
                        ...
                        ref: h,
                        className: r.clsx("bs-skeleton", a, {
                            "bs-skeleton--animate": g
                        }),
                        style: _
                    })
                };
            u.propTypes = l, u.displayName = "BsSkeleton";
            var d = i.memo(u);
            e.exports = d
        },
            ...
            var p = {
                ...
                v = function(e) {
                    var t = e.show,
                        ...
                        D = function() {
                            j || (R.current && clearTimeout(R.current), R.current = setTimeout(function() {
                                void 0 === t && P(!0)
                            }, v))
                        },
                        z = d.useCallback(function() {
                            R.current && clearTimeout(R.current), void 0 === t && P(!1)
                        }, [t]),
                        W = new h,
                        B = d.useCallback(function() {
                            setTimeout(function() {
                                if (M && S.current && C.current) {
                                    var e = S.current.getBoundingClientRect(),
                                        t = !0,
                                        n = S.current.offsetWidth / 2,
                                        o = C.current.offsetWidth / 2,
                                        r = e.left + n - o,
                                        i = e.top - C.current.offsetHeight - 10;
                                    r < 5 ? r = 5 : r + C.current.offsetWidth > window.innerWidth - 20 && (r = window.innerWidth - C.current.offsetWidth - 20), i < 5 && (i = e.top + S.current.offsetHeight + 10, t = !1), C.current.style.top = "".concat(i, "px"), C.current.style.left = "".concat(r, "px"), C.current.style.zIndex = l.popupManager.getNewZIndex().toString(), C.current.dataset.bsTooltipTop = "".concat(t);
                                    var s = C.current.getBoundingClientRect(),
                                        a = S.current.getBoundingClientRect(),
                                        c = s.x + s.width / 2;
                                    if (c < a.left || c > a.right) {
                                        var u = a.x + a.width / 2;
                                        T.current && (T.current.style.right = s.right - u + "px")
                                    }
                                }
                            }, 0)
                        }, [M]),
                        H = d.useCallback(function() {
                            _ && (N.current = setTimeout(function() {
                                z()
                            }, _))
                        }, [_, z]),
                        Y = d.useCallback(function() {
                            "undefined" != typeof document && (M ? (y.onTooltipVisible(), B(), _ && H(), window.addEventListener("scroll", B)) : window.removeEventListener("scroll", B))
                        }, [M, _, B, y, H]);
                    return d.useEffect(function() {
                        return y.init(), W.init(z),
                            function() {
                                "undefined" != typeof window && (y.destroy(), W.destroy(), window.removeEventListener("scroll", B), R.current && clearTimeout(R.current), N.current && clearTimeout(N.current))
                            }
                ...
                var t = e.onExit,
                    ...
                    _ = function(e) {
                        var t = e.onExit,
                            ...
                            p = d[0],
                            f = d[1],
                            m = _sliced_to_array(i.useState(n ? "entered" : "exited"), 2),
                            h = m[0],
                            y = m[1],
                            v = i.useRef(-1);
