        ...
        96803: function(e, o, t) {
            ...
            var y = t(87930),
                ...
                C = (0, _.memo)(function(e) {
                    var o = e.name,
                        ...
                        q = f.isPc && (null == t ? void 0 : t.length) > 1,
                        W = (0, _.useCallback)(function(e) {
                            !y && (B(!0), E && Z(e.selectedScrollSnap()), q && (M(function() {
                        ...
                        F = (0, _.useCallback)(function(e) {
                            E && Z(e.selectedScrollSnap()), q && (M(function() {
                                return e.canScrollNext()
                            }), D(function() {
                                return e.canScrollPrev()
                            }))
                    ...
                    (0, _.useEffect)(function() {
                        y || 1 !== (null == t ? void 0 : t.length) || B(!0)
                    ...
                    return (0, r.jsxs)("div", {
                        className: (0, s.Z)([k()["banner-slider-discovery"], i]),
                        children: [!T && !y && (0, r.jsx)(x.Z, {
                            ratio: V
                        }), (0, r.jsxs)("div", {
                            className: (0, s.Z)(k()["banner-slider-discovery__content"], _define_property({}, k()["banner-slider-discovery__content--hidden"], !T && !y)),
                            children: [q && (0, r.jsxs)(r.Fragment, {
                                children: [(0, r.jsx)(j(), {
                                    className: (0, s.Z)(k()["banner-slider-discovery__next"], _define_property({}, k()["banner-slider-discovery__next--active"], S)),
                                    color: "secondary",
                                    variant: "outline",
                                    icon: "bi-angle-left",
                                    size: "md",
                                    ...
                                    className: (0, s.Z)(k()["banner-slider-discovery__prev"], _define_property({}, k()["banner-slider-discovery__prev--active"], A)),
                                    color: "secondary",
                                    variant: "outline",
                                    icon: "bi-angle-right",
                                    size: "md",
                            ...
                            }), 1 === (null == t ? void 0 : t.length) && (0, r.jsx)(g, {
                                lazy: m,
                                sectionName: o,
                                banner: t[0],
                                metadata: n,
                                ...
                                children: null == t ? void 0 : t.map(function(e, t) {
                                    return (0, r.jsx)(w().Item, {
                                        className: k()["banner-slider-discovery__slider-item"],
                                        children: (0, r.jsx)(g, {
                                            banner: e,
                                            sectionName: o,
                                            lazy: 0 !== t || m,
                                ...
                                className: k()["banner-slider-discovery__pagination"],
                                children: t.map(function(e, o) {
                                    return (0, r.jsx)("button", {
                                        "aria-label": "اسلاید بعدی",
                                        className: (0, s.Z)(k()["banner-slider-discovery__pagination-btn"], _define_property({}, k()["banner-slider-discovery__pagination-btn--active"], o === P)),
                                        onClick: function() {
                                            return R(o)
                                        }
                                    }, o)
            ...
            function M(e) {
                var o = e.isPc,
                    ...
                    v = void 0 === u ? 2 : u,
                    p = _sliced_to_array((0, _.useState)(l < v || n), 2),
                    m = p[0],
                    h = p[1],
                    b = (0, _.useRef)(null);
            ...
            function oe() {
                return (0, r.jsxs)(J(), {
                    className: U()["horizontal-product-timely-skeleton"],
                    children: [(0, r.jsxs)("div", {
                        className: U()["horizontal-product-timely-skeleton__header"],
                        children: [(0, r.jsx)("div", {
                            className: U()["horizontal-product-timely-skeleton__header-icon"],
                            children: (0, r.jsx)($(), {
                                className: U()["horizontal-product-timely-skeleton__icon"]
                            })
                        }), (0, r.jsxs)("div", {
                            className: U()["horizontal-product-timely-skeleton__header-content"],
                            children: [(0, r.jsx)($(), {
                                className: U()["horizontal-product-timely-skeleton__header-title"]
                            }), (0, r.jsx)($(), {
                                className: U()["horizontal-product-timely-skeleton__header-show-all"]
                            })]
                        })]
                    }), (0, r.jsxs)("div", {
                        className: U()["horizontal-product-timely-skeleton__items"],
                        children: [(0, r.jsx)(ee.Z, {
                            className: U()["horizontal-product-timely-skeleton__item"],
                            discountMode: !0
                        }), (0, r.jsx)(ee.Z, {
                            className: U()["horizontal-product-timely-skeleton__item"],
                            discountMode: !0
            ...
            var te = t(26460),
                ...
                ue = i()(function() {
                    return Promise.all([t.e(296), t.e(7339), t.e(1558), t.e(5753)]).then(t.bind(t, 91163))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [91163]
                ...
                _e = i()(function() {
                    return Promise.all([t.e(296), t.e(3620), t.e(7339), t.e(6160), t.e(7480)]).then(t.bind(t, 37572))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [37572]
                ...
                pe = i()(function() {
                    return t.e(8399).then(t.bind(t, 8399))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [8399]
        ...
        69064: function(e, o, t) {
            ...
            function _(e) {
                var o = e.hasLogo,
                    ...
                    g = void 0 !== b && b;
                return (0, r.jsxs)(s(), {
                    className: (0, n.Z)(l()["horizontal-product-popular-skeleton"]),
