        ...
        55633: function(e, t, r) {
            ...
            function p() {
                var e, t = (0, c.Z)(),
                    ...
                    D = (0, u.M_)(["isLoggedIn", "currentUser", "isVendor"]),
                    j = D.isLoggedIn,
                    x = D.currentUser,
                    k = D.isVendor,
                    C = null === (e = b("test_header_direct_login_to_vendor", !1)) || void 0 === e ? void 0 : e.value,
                ...
                return {
                    handleCreateVendorClickBtn: function() {
                        k ? n ? (0, f.Hr)(y.vendorDashboardUrl) : window.location.href = y.vendorDashboardUrl : (g("test_header_direct_login_to_vendor"), "indirect" === C ? ((0, a.s)("createVendorClick", {
                            location: "header"
                        }), t.push("/landings/create-vendor")) : "direct" === C && (Z ? m("در حال حاضر امکان ساخت غرفه وجود ندارد.") : j ? I() : _({
                            callback: function() {
                                return I()
                            }
                        })))
        ...
        92518: function(e, t, r) {
            ...
            function y(e) {
                var t, r, s = e.user,
                    ...
                    k = _sliced_to_array((0, o.useState)(s.isFollowedByCurrentUser), 2),
                    C = k[0],
                    Z = k[1],
                    I = (0, d.Kn)(),
                    P = I.mutate,
                ...
                return (0, n.jsxs)("div", {
                    ...
                    }), s.name, s.id !== (null == D ? void 0 : D.id) && (!C && (null === (r = s.vendor) || void 0 === r ? void 0 : r.isActive) ? (0, n.jsx)(g(), {
                        size: "sm",
                        color: "secondary",
                        variant: "outline",
        ...
        73599: function(e, t, r) {
            ...
            function v(e) {
                var t, r = e.userId,
                    ...
                    _ = p.isLoading,
                    m = p.data,
                    D = (null == m || null === (t = m.pages) || void 0 === t ? void 0 : t.flatMap(function(e) {
                        return e.openapiRawData
                    })) || [],
                    j = function() {
