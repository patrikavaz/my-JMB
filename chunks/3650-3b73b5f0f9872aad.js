                ...
                v = l.forwardRef(function(e, t) {
                    ...
                    return l.useEffect(function() {
                        S !== Ie && (S ? _async_to_generator(function() {
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    ...
                                    case 2:
                                        return e.sent(), Ee(!0), ct(!0), it(), Fe.current && (Fe.current.style.zIndex = "".concat(c.popupManager.getNewZIndex())), st(), c.popupManager.setIsOpen(Me), [2]
                                }
                            })
                        })() : Ee(!1))
                    }, [S]), u.useEffectNoImmediate(function() {
                        Ie || (ot(), ct(!1), c.popupManager.setIsClosed(Me, 400))
                        ...
                        return c.popupManager.subscribe(e),
                            function() {
                                Ee(!1), c.popupManager.unsubscribe(e), c.popupManager.setIsClosed(Me, 400), ot()
                            }
                    }, []), r.jsx(s, {
                        children: r.jsxs("div", {
                            ref: Fe,
                                        ...
                                        return _ts_generator(this, function(r) {
                                            switch (r.label) {
                                                case 0:
                                                    return [4, l.sleep(0)];
                                                case 1:
                                                    return r.sent(), ee ? [2] : Number(K) <= N ? [2, void(null == n || n())] : (e = z ? B : d, t = Number(K) - e < N ? N : Number(K) - e, Z(t), null == g || g(t), [2])
                                            }
                                        })
                                    })()
                                },
                ...
                P = function(e, t) {
                    t = t || {}, _(function() {
                        ...
                        o = l(e, a, C, t.reportAllChanges), d && ("PerformanceEventTiming" in window && "interactionId" in PerformanceEventTiming.prototype && d.observe({
                            ...
                            I = [], M = k(), o = l(e, a = c("INP"), C, t.reportAllChanges)
                        }))
                    })
                },
                D = [2500, 4e3],
