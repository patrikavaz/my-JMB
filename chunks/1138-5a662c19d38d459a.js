            ...
            var n = t(13014),
                ...
                _ = function(e) {
                    ...
                    return (0, u.N)(_object_spread({
                        ...
                        queryKey: ["reels"].concat(_to_consumable_array(s ? [n.d.user_reels, s] : [n.d.owner_reels, p])),
                        queryFn: function(e) {
                            var r = e.pageParam,
                                n = void 0 === r ? 0 : r;
                            return (0, l.MB)({
                ...
                v = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                        ...
                        t = e.isFrom,
                        o = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
                        i = r ? Array.isArray(r) ? r : [r] : ["review", "business"],
                        u = (0, a.hu)({
        ...
        25977: function(e, r, t) {
            ...
            function l(e) {
                var r, t, l, c, d = (0, u.Z)(),
                    ...
                    m = v.data,
                    y = v.isLoading,
                    g = p === (null == m || null === (t = m.user) || void 0 === t ? void 0 : t.id) || !b && "reels" === d.query.tab,
                    h = (0, o.XT)({
                        enabled: !(y || !e),
                        userId: g ? null : null == m || null === (l = m.user) || void 0 === l ? void 0 : l.id
                    }),
                    A = h.data,
                    j = h.isLoading,
                    w = _sliced_to_array(function(e) {
                        var r = (0, s.l)().getFeatureValue,
                    ...
                    R = x.reelsConfirmedCount,
                    F = x.reelsCheckingCount,
                    S = (null == f || null === (c = f.vendor) || void 0 === c ? void 0 : c.isActive) && k;
                return {
                    isLoading: y || j,
                    isReelsOwner: g,
                    isReelsCreator: S,
                    reelsCheckingCount: F,
                    canWatchReelsInPdp: O,
                    maxUploadReelsCount: D,
                    reelsConfirmedCount: R,
                    showReelsInDiscovery: S || P,
                    canImportFromInstagram: I,
                    canWatchReelsInDiscovery: P,
                    canWatchReelsInSearchItem: q,
