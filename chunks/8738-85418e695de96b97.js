        ...
        60802: function(e, t, r) {
            ...
            function w(e) {
                ...
                (0, _.Z)(function() {
                    ...
                    var e = B();
                    e && x.current && r && (!k || C) && x.current.setAttributes(_object_spread_props(_object_spread({}, N), {
                        deviceId: e
                    }))
                }, [r, N, B]);
                var D = function() {
                        ...
                        return e.setFeatures(E), (!r || T) && e.setAttributes(N), e
                    },
                    R = (0, b.useCallback)(function(e) {
                        ...
                        try {
                            ...
                            } else(0, o.s)("viewedExperiment", _object_spread({
                                deviceId: g,
                                orderCount: P,
                                pageUrl: y.asPath,
                                userId: Number(O),
                    ...
                    V = (0, b.useCallback)(function(e) {
                        ...
                        return (null == c ? void 0 : c.experiment) && "experiment" === (null == c ? void 0 : c.source) ? !r || !h && T ? (F.current = _object_spread_props(_object_spread({}, F.current), _define_property({}, e, c)), i && R(e, u), null == F ? void 0 : F.current[e]) : (console.warn("can not run this function in cached page before mounted! [".concat(e, "]")), {}) : c || {}
                    }, [D, h, j, T]),
                ...
                return (0, b.useEffect)(function() {
                    var e;
                    (null == C || null === (e = C.markedType) || void 0 === e ? void 0 : e.id) === i.Pw.BASALAM_COLLEAGUES && (window.runGBTest = V)
                }, [V]), (0, b.useEffect)(function() {
                    W(!0), x.current || j && window.WebviewInterfaceVersion !== f.gO.MOSTLY_WEBVIEW || (x.current = D())
                }, []), (0, n.jsx)(v.Provider, {
                    value: K,
                    children: t
                })
                                ...
                                if (n) {
                                    ...
                                    if (n.version === i.gO.PARTIAL_WEBVIEW) window.location.href = "".concat(c.customerPrefix, "://conversation/").concat(e);
                                        ...
                                        var l = t.hasProductForWebview,
                                            ...
                                            j = l.canAddToCart,
                                            S = l.vendorCityName,
                                            C = l.vendorIdentifier,
                                            k = l.status,
                                            O = l.hasVariation;
                                        null === (u = n.openLink) || void 0 === u || u.call(n, "".concat(o.baseUrl, "/account/chats/").concat(e, "?client=app&screen.type=native&productPrimaryPrice=").concat(p, "&productPrice=").concat(d, "&productName=").concat(_, "&productPicture=").concat(h, "&productId=").concat(v, "&userId=").concat(b, "&vendorId=").concat(f, "&productRating=").concat(y, "&productInventory=").concat(w, "&productReviewCount=").concat(g, "&vendorTitle=").concat(m, "&canAddToCart=").concat(j, "&vendorCityName=").concat(S, "&vendorIdentifier=").concat(C, "&productStatus=").concat(k, "&productHasVariation=").concat(O))
