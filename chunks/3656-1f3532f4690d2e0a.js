            ...
            var t = n(27434),
                ...
                y = function(e) {
                    ...
                    return (0, i.N)(_object_spread({
                        ...
                        queryKey: ["reels"].concat(_to_consumable_array(a ? [p, a] : [l, d])),
                ...
                w = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return (0, a.Db)(_.Hi, e)
                },
                D = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return (0, a.Db)(_.Q2, e)
                },
                I = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return (0, a.Db)(_.H4, e)
                },
                P = function() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    return (0, a.Db)(_.Y8, e)
                },
                N = function(e, r) {
                    var n = (0, c.NL)();
                    return (0, t.useCallback)(function(t, o) {
                        n.setQueryData(["reels"].concat(_to_consumable_array(e ? [l, !0] : [p, r])), function(e) {
                            return _object_spread_props(_object_spread({}, e), {
                                pages: e.pages.map(function(e) {
                                    return _object_spread_props(_object_spread({}, e), {
                                        reels: e.reels.map(function(e) {
                ...
                L = function() {
                    ...
                    return (0, t.useCallback)(function(r, n) {
                        e.setQueryData(["reels", l, !0], function(e) {
                            return _object_spread_props(_object_spread({}, e), {
                                pages: e.pages.map(function(e) {
                                    return _object_spread_props(_object_spread({}, e), {
                ...
                A = function() {
                    var e = (0, c.NL)();
                    return (0, t.useCallback)(function(r, n) {
                        e.setQueryData(["reels", l, !1], function(e) {
                            return _object_spread_props(_object_spread({}, e), {
                                pages: e.pages.map(function(e) {
                                    return _object_spread_props(_object_spread({}, e), {
                                        reels: e.reels.filter(function(e) {
        ...
        33656: function(e, r, n) {
            ...
            function c(e) {
                var r, n, c, _, l = (0, i.Z)(),
                    ...
                    v = null == l || null === (r = l.query) || void 0 === r ? void 0 : r.vendorIdentifier,
                    m = (0, u.b)(v),
                    j = m.data,
                    y = m.isLoading,
                    g = d === (null == j || null === (n = j.user) || void 0 === n ? void 0 : n.id) || !v && "reels" === l.query.tab,
                    h = (0, o.XT)({
                        limit: 6,
                        enabled: !(y || !e),
                    ...
                    A = q.reelsConfirmedCount,
                    F = q.reelsCheckingCount,
                    M = (null == f || null === (_ = f.vendor) || void 0 === _ ? void 0 : _.isActive) && D;
                return {
                    isLoading: y || k,
                    isReelsOwner: g,
                    isReelsCreator: M,
                    showReelsInSearch: M || N,
                    reelsCheckingCount: F,
                    canWatchReelsInTab: O,
                    canWatchReelsInPdp: L,
                    maxUploadReelsCount: R,
                    reelsConfirmedCount: A,
