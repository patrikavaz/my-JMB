...
function _ts_generator(e, r) {
    ...
    [5405, 5399, 5627], {
        4260: function(e, r, t) {
            ...
            var n = t(32930),
                ...
                v = u.forwardRef(function(e, r) {
                    var s = e.id,
                        ...
                        P = N[0],
                        I = N[1],
                        M = _sliced_to_array(u.useState(!1), 2),
                        S = M[0],
                        D = M[1];
                    ...
                    return u.useEffect(function() {
                        ...
                        return c.endsWith(".m3u8") ? E() : Z(),
                            function() {
                                var e;
                                null === (e = C.current) || void 0 === e || e.destroy()
                            }
                    }, [c, E, Z]), u.useEffect(function() {
                    ...
                    }, [y, R, L, q, k]), n.jsxs("div", {
                        className: o.clsx("bs-video", b),
            ...
            v.propTypes = c, v.displayName = "BsVideo", e.exports = v
        },
        75627: function(e, r, t) {
            ...
            function x(e) {
                var r, t, i, a, s, v, p, y, b = e.story,
                    ...
                    D = (null === (r = b.photo) || void 0 === r ? void 0 : r.url) || (null === (t = b.video) || void 0 === t ? void 0 : t.thumbnail),
                ...
                return (0, n.jsxs)(n.Fragment, {
                    children: [(0, n.jsxs)("div", {
                        ...
                        children: [b.video ? (0, n.jsx)(h(), {
                            poster: S ? null === (i = b.video) || void 0 === i ? void 0 : i.thumbnail : void 0,
                            playsInline: !0,
                            ...
                            children: [(0, n.jsx)(_(), {
                                ...
                                src: null == b || null === (v = b.user) || void 0 === v || null === (s = v.avatar) || void 0 === s ? void 0 : s.small
                            }), (0, n.jsx)("p", {
            ...
            function f(e) {
                var r = e.name,
                    ...
                    R = (0, p.useCallback)(function(e) {
                        x.isMobile && (e.stopPropagation(), I(function(e) {
                            return !e
                        }))
                    }, [P]);
                (0, p.useEffect)(function() {
                    var e;
                    m && (C(!0), null == E || null === (e = E.current) || void 0 === e || e.play())
                }, [m]);
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(_(), {
                        ...
                        ref: E,
                        onPause: function(e) {
                            return null == E || null === (r = E.current) || void 0 === r || r.pause(), C(!1), void(v && v());
                            var r
                        },
            ...
            r.default = (0, u.memo)(function(e) {
                var r = e.name,
                    ...
                    y = (0, u.useMemo)(function() {
                        return a.autoplay && [(0, _.BsLightCarouselAutoplayPlugin)({
                            delay: a.autoplay
                        })]
                    }, [a.autoplay]),
                            ...
                            if (0 !== (null == e || null === (t = e.openapiRawData) || void 0 === t ? void 0 : t.length)) {
                                ...
                                try {
                                    for (var d, v = r[Symbol.iterator](); !(l = (d = v.next()).done); l = !0) {
                                        var _ = d.value;
                                        try {
                                            for (var p, f = _.openapiRawData[Symbol.iterator](); !(i = (p = f.next()).done); i = !0) {
                                                var y = p.value;
                                ...
                                pages: e.pages.map(function(e) {
                                    return _object_spread_props(_object_spread({}, e), {
                                        components: e.components.map(function(e) {
                                            var r;
                                            return "story" === (null == e ? void 0 : e.type) && (null == e || null === (r = e.story) || void 0 === r ? void 0 : r.id) === t ? _object_spread_props(_object_spread({}, e), {
                                                story: _object_spread({}, e.story, n)
                                            }) : "stories" === (null == e ? void 0 : e.type) ? _object_spread_props(_object_spread({}, e), {
                                                stories: e.stories.map(function(e) {
                                                    return (null == e ? void 0 : e.id) === t ? _object_spread({}, e, n) : e
                                                })
                                            }) : e
                                        })
                                    })
        ...
        38251: function(e, r, t) {
            ...
            function ne(e) {
                var r, t, n, o, a = e.isServer,
                    ...
                    A = S.hasNextPage,
                    T = S.fetchNextPage,
                    z = S.isFetchingNextPage,
                    F = (null == D ? void 0 : D.pages.length) > 0 && !A && M,
                    ...
                    U = (0, p.useMemo)(function() {
                        var e, r, t, n, o, i;
                        return "billboard_image" === (null == B || null === (e = B[0]) || void 0 === e ? void 0 : e.ui) ? null === (i = B[0].result) || void 0 === i || null === (o = i[0]) || void 0 === o || null === (n = o.metadata) || void 0 === n || null === (t = n.images) || void 0 === t || null === (r = t[0]) || void 0 === r ? void 0 : r[l.isPc ? "desktopUrl" : "url"] : null
                    }, [B, l.isPc]);
                (0, p.useEffect)(function() {
                    (!Z && !z && (null == B ? void 0 : B.length) > 4 || O) && b(!1)
                }, [Z, z, null == B ? void 0 : B.length, O]);
                ...
                return (0, i.jsxs)("div", {
                    ...
                    children: [(0, i.jsx)(j, {
                        ...
                        hasMore: !(z || O || Z || !A),
                        hasError: !(!A || !O),
                        threshold: a ? V : l.isPc ? 400 : 10,
                        children: [!!(null == B ? void 0 : B.length) && (0, i.jsx)(E.Z, {
            ...
            var oe = t(94914),
                ie = (0, o.isClientSide)();
            ne.getInitialProps = function(e) {
                return _async_to_generator(function() {
                    var r, t, o, i, a, s, l, u, c, d, v, _, p, f, y, m, b, h, j, g;
                    return _ts_generator(this, function(x) {
                        switch (x.label) {
                            case 0:
                                if (r = e.req, t = e.res, o = e.userId, i = e.isWebview, a = e.queryClient, s = e.isCachedPage, !r) return [2, {}];
                                x.label = 1;
                            case 1:
                            ...
                            case 2:
                                return f = x.sent(), !((null == f || null === (c = f.pages) || void 0 === c || null === (u = c[0]) || void 0 === u || null === (l = u.items) || void 0 === l ? void 0 : l.length) > 0) && t && (r.app.noCache = !0), (y = null == f || null === (d = f.pages) || void 0 === d ? void 0 : d[0]) && y.items.length > p && s && (m = y.items.slice(0, p).map(function(e) {
                                    return _object_spread_props(_object_spread({}, e), {
                                        fromCache: !0
                                    })
                                }), b = y.items.slice(p), a.setQueryData(["first-page-discovery"], _object_spread_props(_object_spread({}, f), {
                                    pages: [_object_spread_props(_object_spread({}, y), {
                                        items: m,
                                        meta: _object_spread_props(_object_spread({}, y.meta), {
                                            _hasPartialData: !0,
                                            lastRank: (null === (_ = y.items) || void 0 === _ || null === (v = _[p - 1]) || void 0 === v ? void 0 : v.rank) || 0,
                            ...
                            case 3:
                                return h = x.sent(), j = (0, n.Pt)(h), g = 422 === (null == j ? void 0 : j.statusCode) ? 404 : j.statusCode || 500, [2, (!ie && t && (t.statusCode = g), {
                                    error: {
                                        statusCode: g
                                    }
                                })];
    ...
    function(e) {
        e.O(0, [973, 9922, 246, 8293, 5382, 5250, 8214, 4914, 7314, 2026, 4287, 4859, 9691, 8020, 3853, 1740, 9774, 2888, 179], function() {
            return e(e.s = 45728)
        }), _N_E = e.O()
    }
]);