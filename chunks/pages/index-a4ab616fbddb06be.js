...
function _ts_generator(e, r) {
    ...
    [5405, 5399, 5627], {
        1103: function(e, r, t) {
            ...
            t(32930);
            var n = t(99249);
            t(36350), t(27434), t(50874), e.exports = n.BsTransition
        },
        4260: function(e, r, t) {
            "use strict";
            var n = t(32930),
                ...
                _ = u.forwardRef(function(e, r) {
                    var s = e.id,
                        ...
                        N = u.useRef(),
                        C = _sliced_to_array(u.useState(!1), 2),
                        P = C[0],
                        I = C[1],
                                    ...
                                    switch (n.label) {
                                        ...
                                        case 2:
                                            return e && e.isSupported() && k.current ? (N.current = new e({
                                                startLevel: 3
                                            }), N.current.loadSource(c), N.current.attachMedia(k.current)) : k.current && k.current.canPlayType("application/vnd.apple.mpegurl") && (k.current.src = c), [3, 4];
                                        case 3:
                    ...
                    return u.useEffect(function() {
                        ...
                        k.current && (k.current.addEventListener("play", L), k.current.addEventListener("pause", R), k.current.addEventListener("ended", R), k.current.addEventListener("canplay", q));
                        var e = k.current;
                        return function() {
                            var r;
                            null === (r = N.current) || void 0 === r || r.destroy(), null == e || e.removeEventListener("play", L), null == e || e.removeEventListener("pause", R), null == e || e.removeEventListener("ended", R), null == e || e.removeEventListener("canplay", q)
                        }
                    }, [y, q, R, L, k]), n.jsxs("div", {
        ...
        75627: function(e, r, t) {
            ...
            var n = t(32930),
                ...
                h = t.n(b),
                j = a()(function() {
                    return Promise.all([t.e(3620), t.e(2584), t.e(9477), t.e(8032)]).then(t.bind(t, 62717))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [62717]
        ...
        32888: function(e, r, t) {
            ...
            function f(e) {
                ...
                (0, p.useEffect)(function() {
                    var e;
                    m && (N(!0), null == E || null === (e = E.current) || void 0 === e || e.play())
                }, [m]);
                var A = (0, p.useMemo)(function() {
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [(0, n.jsx)(v(), {
                        ...
                        ref: E,
                        onPause: function(e) {
                            return null == E || null === (r = E.current) || void 0 === r || r.pause(), N(!1), void(_ && _());
                            var r
                        },
        ...
        38251: function(e, r, t) {
            ...
            var J = u()(function() {
                ...
                $ = u()(function() {
                    return Promise.resolve().then(t.bind(t, 6976))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [6976]
                ...
                ee = u()(function() {
                    return t.e(5190).then(t.bind(t, 44969))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [44969]
                ...
                re = u()(function() {
                    return Promise.all([t.e(9836), t.e(1702)]).then(t.bind(t, 49836))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [49836]
            ...
            function ie(e) {
                var r, t, n, o, i = e.isServer,
                    ...
                    F = (null == D ? void 0 : D.pages.length) > 0 && !R && M,
                ...
                (0, y.useEffect)(function() {
                    (!E && !z && (null == B ? void 0 : B.length) > 3 || O) && b(!1)
                }, [E, z, null == B ? void 0 : B.length, O]);
                ...
                return (0, s.jsxs)("div", {
                    ...
                    children: [(0, s.jsx)(x, {
                        ...
                        active: "HOME"
                    }), (0, s.jsx)(N.Z, {}), (0, s.jsxs)(P(), {
                        loadingComponent: null,
                        fetchMore: Q,
                        hasMore: !(z || O || E || !R),
                        hasError: !(!R || !O),
                        threshold: i ? V : l.isPc ? 400 : 10,
                        children: [!!(null == B ? void 0 : B.length) && (0, s.jsx)(L.Z, {
                    ...
                    return _ts_generator(this, function(N) {
                        switch (N.label) {
                            case 0:
                                ...
                                N.label = 1;
                            case 1:
                                return N.trys.push([1, 3, , 4]), y = o()(a), m = y.isMobile || s ? 2 : 3, [4, l.fetchInfiniteQuery(["first-page-discovery"], function() {
                                    return (0, A._I)({
                                        userId: n || 0,
                                        config: {
                                            req: r,
                            ...
                            case 2:
                                return b = N.sent(), !((null == b || null === (_ = b.pages) || void 0 === _ || null === (d = _[0]) || void 0 === d || null === (c = d.items) || void 0 === c ? void 0 : c.length) > 0) && t && (r.app.noCache = !0), (h = null == b || null === (v = b.pages) || void 0 === v ? void 0 : v[0]) && h.items.length > m && u && (j = h.items.slice(0, m).map(function(e) {
                                    return _object_spread_props(_object_spread({}, e), {
                                        fromCache: !0
                                    })
                            ...
                            case 3:
                                return x = N.sent(), w = (0, i.Pt)(x), k = 422 === (null == w ? void 0 : w.statusCode) ? 404 : w.statusCode || 500, [2, (!se && t && (t.statusCode = k), {
                                    error: {
                                        statusCode: k
                                    }
                                })];
    ...
    function(e) {
        e.O(0, [456, 8818, 5382, 878, 4263, 4945, 7314, 6976, 3656, 9361, 9691, 8378, 1740, 4410, 9774, 2888, 179], function() {
            return e(e.s = 45728)
        }), _N_E = e.O()
    }
]);