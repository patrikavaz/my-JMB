        ...
        22434: function(e, n, o) {
            ...
            n.Z = function(e) {
                ...
                return (0, r.Db)(t.xS, _object_spread({
                    onSuccess: function() {
                        if (l.bsLocalStorage.removeItem(d.hz), l.bsLocalStorage.removeItem(_.D), l.bsLocalStorage.removeItem(b.S), (0, u.isIosApp)() && (0, f.getFcmToken)()) a({
                            ...
                            (0, h.S)(), (0, p.y)(), s()() && l.bsLocalStorage.removeItem(i.gm), g.has(n) ? window.location.href = "/" : window.location.reload()
                        }
                    }
                }, o))
            }
