        ...
        56794: function(e, r, t) {
            ...
            function j(e) {
                var r = e.newUi,
                    ...
                    C = (0, f.Z)(),
                    N = _sliced_to_array((0, g.useState)(!1), 2),
                    O = N[0],
                    P = N[1],
                    L = _sliced_to_array((0, g.useState)(null), 2),
                    I = L[0],
                    E = L[1],
                    M = _sliced_to_array((0, g.useState)(r ? 96 : 80), 2),
                    z = M[0],
                    Z = M[1],
                    R = _sliced_to_array((0, g.useState)(r ? 126 : 97), 2),
                    U = R[0],
                    T = R[1],
                    V = _sliced_to_array((0, g.useState)(null), 2),
                    Y = V[0],
                    B = V[1],
                    A = _sliced_to_array((0, g.useState)(null), 2),
                    D = A[0],
                    W = A[1],
                    G = _sliced_to_array((0, g.useState)(null), 2),
                    F = G[0],
                    K = G[1],
                    Q = (0, g.useRef)(),
                    q = (0, g.useRef)(null),
                    ...
                    ee = (0, g.useCallback)(function(e) {
                        ...
                        B(-1 === n ? null : t[n].user.id), W(-1 === i ? null : t[i].user.id), null == S || S(n)
                            ...
                            return _ts_generator(this, function(o) {
                                switch (o.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return o.sent(), X && window.WebviewInterfaceVersion === m.gO.MOSTLY_WEBVIEW ? (n = (0, m.Cw)(), i = [], null == t || t.forEach(function(e) {
                                            var r = _object_spread({}, e, e.user);
                                            Number.isNaN(Number(r.id)) || i.push(r)
                                        }), null === (r = n.onStoryClick) || void 0 === r || r.call(n, JSON.stringify((0, _.snakize)(i)), e)) : (ee(e), P(!0), K(null)), [2]
                                }
                            })
                        })()
                            ...
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return e.sent(), null === Y ? te() : (ee(Y), K("first")), [2]
                                }
                            })
                        })()
                    }, [te, Y, ee]),
                            ...
                            return _ts_generator(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, window.scheduler.yield()];
                                    case 1:
                                        return e.sent(), null !== D && (ee(D), K(null)), [2]
                                }
                            })
                        })()
                    }, [D, ee]),
                ...
                return (0, g.useEffect)(function() {
                    z > 0 && ue.measure()
                }, [z, ue]), (0, g.useLayoutEffect)(function() {
                    var e = function() {
                            ...
                            children: (0, n.jsx)("div", {
                                ...
                                children: ue.getVirtualItems().map(function(e) {
                                    var s, a = window.innerWidth >= 992 ? 16 : 8,
                                        _ = null == t ? void 0 : t[e.index],
                                        y = e.index === ((null == t ? void 0 : t.length) || 0) - 2;
                                    return (0, n.jsx)("div", {
                                        ...
                                        children: (0, n.jsx)("div", {
                                            ...
                                            children: (0, n.jsxs)("div", {
                                                ...
                                                children: ["STORY_SKELETON" === _.component && (0, n.jsx)(d.Z, {
                                                    count: 1,
                                                    newUi: r
                                                }), "PUBLIC_STORY" === _.component && (0, n.jsx)(c.Z, {
                                                    isLazy: l,
                                                    onClick: null !== (s = _.onClick) && void 0 !== s ? s : re,
                                                    user: _,
                                                    newUi: r
                                                }), "MY_STORY" === _.component && _.show && (0, n.jsx)(o.Z, {
                                                    isLazy: l
                                                }), "DISCOVERY" === _.component && _.show && (0, n.jsx)(h.Z, {
                                                    onClick: se
                                                }), "LIVE" === _.component && (0, n.jsx)(b.Z, {
                                                    onClick: ae,
                                                    isLazy: l
                                                }), "REELS" === _.component && (0, n.jsx)(p.Z, {
                                                    isLazy: l
                                                })]
                                            }, _.user.id)
                                        })
                            ...
                            children: t.map(function(e, s) {
                                ...
                                return (0, n.jsxs)("div", {
                                    ...
                                    children: ["STORY_SKELETON" === e.component && (0, n.jsx)(d.Z, {
                                        ...
                                        isLazy: l,
                                        onClick: null !== (a = e.onClick) && void 0 !== a ? a : re,
                                        user: e,
                                        newUi: r
                                    }), "MY_STORY" === e.component && e.show && (0, n.jsx)(o.Z, {
                                        isLazy: l
                                    }), "DISCOVERY" === e.component && e.show && (0, n.jsx)(h.Z, {
                                        onClick: se
                                    }), "LIVE" === e.component && (0, n.jsx)(b.Z, {
                                        onClick: ae,
                                        isLazy: l
                                    }), "REELS" === e.component && (0, n.jsx)(p.Z, {
                                        isLazy: l
                                    })]
                                }, e.user.id)
                            })
