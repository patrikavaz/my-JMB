            ...
            function C(e) {
                var r = e.show,
                    ...
                    W = (0, v.useCallback)(function(e) {
                        ...
                        o.current = r, clearTimeout(i.current), i.current = setTimeout(function() {
                    ...
                    L = (0, v.useCallback)(function(e) {
                        if (s.current = e, null !== e) {
                            var r, t = w(h.pathname);
                            void 0 !== t && (M.current = t.key);
                            var a = (null === (r = h.query) || void 0 === r ? void 0 : r.q) || "";
                ...
                (0, v.useEffect)(function() {
                    ...
                    if (!r) return N(!1), void setTimeout(function() {
                        var e, r;
                    ...
                    var e = 0;
                    return function r() {
                            (!s.current || document.activeElement !== s.current) && (e += 1, s.current && document.activeElement !== s.current ? (s.current.focus(), document.activeElement !== s.current && e < 20 && setTimeout(r, 100)) : e < 20 && setTimeout(r, 100))
                        }(),
                        function() {
                    ...
                    var e;
                    if (r && !E) {
                        var t = null === (e = F("test_autocomplete_service")) || void 0 === e ? void 0 : e.value;
                        T(t)
                    }
                }, [E, r, F]), (0, v.useEffect)(function() {
