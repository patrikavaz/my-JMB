        ...
        37314: function(e, t, r) {
            ...
            function y(e) {
                var t = e.title,
                    ...
                    O = (0, m.useRef)(),
                    S = _sliced_to_array((0, m.useState)(58), 2),
                    N = S[0],
                    P = S[1],
            ...
            function k(e) {
                var t = e.show,
                    ...
                    J = (0, x.useCallback)(function() {
                        setTimeout(function() {
                            var e;
                            null === (e = m.current) || void 0 === e || e.select()
                        }, 300)
                    }, []);
                (0, x.useEffect)(function() {
                    ...
                    var e = 0;
                    return function t() {
                            (!m.current || document.activeElement !== m.current) && (e += 1, m.current && document.activeElement !== m.current ? (m.current.focus(), document.activeElement !== m.current && e < 20 && setTimeout(t, 100)) : e < 20 && setTimeout(t, 100))
                        }(),
                        function() {
                ...
                var P = (0, c.useMemo)(function() {
                    ...
                    T = (0, c.useCallback)(function(e, t) {
                        var r = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                            ...
                            m = t || p;
                        l && (m = "/cat/".concat(u).concat(l ? "/".concat(l) : "")), o && !s && (m = "/".concat(o)), "/account/vendor" === f.pathname && (m = "/account/vendor");
                        ...
                        _ ? f.push(m + (0, a.stringifyQuery)(y)) : S(y)
                    }, [f.asPath, O]),
