...
function _ts_generator(t, e) {
    ...
    [1198], {
        71511: function(t, e, n) {
            ...
            function c(t) {
                var e = t.productId,
                    ...
                    a = t.isLight,
                    s = void 0 !== a && a;
                return o.DZ.post("/web/v1/order/basket/item?light=".concat(s), (0, r.snakize)({
                    productId: e,
                    quantity: i,
                    variationId: c
                }))
        ...
        81918: function(t, e, n) {
            ...
            function b(t) {
                ...
                D && (D.onmessage = function(t) {
                    ...
                    var t, e;
                    (null === (t = h.data) || void 0 === t ? void 0 : t.lastItem) && (null == D || null === (e = D.postMessage) || void 0 === e || e.call(D, {
        ...
        41581: function(t, e, n) {
            ...
            function v() {
                var t, e, n, r, o, u, c = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    a = c.product,
                    d = c.variationId,
                    v = s(),
                    p = (0, i.tC)(a.variants, d),
                    _ = v.find(function(t) {
                        return t.id === a.vendor.id
                    }),
                    b = null !== (r = a.title) && void 0 !== r ? r : a.name,
                    g = null !== (o = null === (t = a.vendor) || void 0 === t ? void 0 : t.title) && void 0 !== o ? o : null === (e = a.vendor) || void 0 === e ? void 0 : e.name,
                    h = {
                        errors: [],
                        quantity: 1,
                        id: a.id,
                        ...
                        product: {
                            ...
                            stock: a.stock,
                            photo: a.photo,
                            category: null !== (u = a.category) && void 0 !== u ? u : null,
                            primaryPrice: a.primaryPrice || a.price,
                            photos: [{
                                resized: {
                                    sm: (null === (n = a.photo) || void 0 === n ? void 0 : n.sm) || a.photo
                                }
                            }]
                        }
                    };
                if (p && (h.price = p.price, h.product.stock = p.stock, h.product.price = p.price, h.product.primaryPrice = p.primaryPrice, h.variation = {
                        id: p.id,
                        stock: p.stock,
                        price: p.price,
                        primaryPrice: p.primaryPrice,
                        properties: p.properties.map(function(t) {
                            var e = t.property;
                            return {
                                value: t.value,
                                property: {
                    ...
                    identifier: a.vendor.identifier
                });
                return f(v), v
            }
