    ...
    [1198], {
        71511: function(t, e, n) {
            ...
            function i() {
                ...
                return o.DZ.get("/web/v1/order/basket", _object_spread_props(_object_spread({}, n), {
        ...
        81918: function(t, e, n) {
            ...
            function b(t) {
                ...
                }), (0, l.useEffectNoImmediate)(function() {
                    var t, e;
        ...
        41581: function(t, e, n) {
            ...
            function l() {
                ...
                if (l && (g.price = l.price, g.product.stock = l.stock, g.product.price = l.price, g.product.primaryPrice = l.primaryPrice, g.variation = {
                        id: l.id,
                        stock: l.stock,
                        price: l.price,
                        primaryPrice: l.primaryPrice,
                        properties: l.properties.map(function(t) {
                            var e = t.property;
                            return {
                                value: t.value,
                                property: {
