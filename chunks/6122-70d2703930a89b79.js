...
function _ts_generator(e, n) {
    ...
    [6122, 3508], {
        66456: function(e, n, t) {
            ...
            function f() {
                return (0, o.jsx)("div", {
                    className: m()["clickable-coupon"],
                    children: (0, o.jsx)(_(), {
                        children: (0, o.jsx)("div", {
                            className: m()["clickable-coupon__container"],
                            children: (0, o.jsxs)("div", {
                                className: m()["clickable-coupon__skeleton"],
                                children: [(0, o.jsx)(b(), {
                                    width: "200px",
                                    height: "32px",
                                    radius: "8px",
                                    ...
                                    className: m()["clickable-coupon__skeleton-decorations"],
                                    children: [(0, o.jsx)("div", {
                                        className: m()["clickable-coupon__skeleton-decoration--left"],
                                        children: (0, o.jsx)(b(), {
                                            width: "80px",
                                            height: "80px",
                                            radius: "50%"
                                        ...
                                        className: m()["clickable-coupon__skeleton-decoration--right"],
                                        children: (0, o.jsx)(b(), {
                                            width: "90px",
                                            height: "90px",
                                            radius: "50%"
                                        ...
                                        className: m()["clickable-coupon__skeleton-decoration--top-right"],
                                        children: (0, o.jsx)(b(), {
                                            width: "40px",
                                            height: "40px",
                                            radius: "50%"
                                    ...
                                    className: m()["clickable-coupon__skeleton-main"],
                                    children: (0, o.jsx)(b(), {
                                        width: "180px",
                                        height: "180px",
                                        radius: "50%"
                                    ...
                                    className: m()["clickable-coupon__skeleton-hint"],
                                    children: (0, o.jsx)(b(), {
                                        width: "250px",
                                        height: "20px",
                                        radius: "4px"
                    ...
                    return function(e) {
                        var n = function(n) {
                            ...
                            return (0, i.useLayoutEffect)(function() {
                                x || (!p && b && (!!m.current.dataset.hydrationOnDemand || c) || C())
                                ...
                                N(!0)
                            }, [k.asPath]), x ? (0, o.jsx)("section", _object_spread_props(_object_spread({
                                ref: m
                            }, a), {
