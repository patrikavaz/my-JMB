    ...
    [7314], {
        58507: function(e, r, t) {
            ...
            var a = t(32930),
                ...
                v = t(89504),
                x = _()(function() {
                    return Promise.all([t.e(973), t.e(246), t.e(5382), t.e(337), t.e(9161), t.e(4691), t.e(1402)]).then(t.bind(t, 64691))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [64691]
            ...
            function w(e) {
                ...
                return _("search-focus", function() {
                    ...
                    requestIdleCallback(function() {
                        t.e(9e3).then(t.bind(t, 99e3)), Promise.all([t.e(973), t.e(5625), t.e(268)]).then(t.bind(t, 15625))
                    })
                }, []), (0, a.jsxs)(a.Fragment, {
        ...
        28030: function(e, r, t) {
            ...
            var a = t(32930),
                ...
                j = o()(function() {
                    return Promise.all([t.e(973), t.e(5625), t.e(268)]).then(t.bind(t, 15625))
                }, {
                    loadableGenerated: {
                        webpack: function() {
                            return [15625]
            ...
            function C(e) {
                var r = e.show,
                    ...
                    _ = (0, v.useRef)(null),
                    f = (0, v.useRef)(null),
                    m = _sliced_to_array((0, v.useState)(""), 2),
                    p = m[0],
                    C = m[1],
                    O = _sliced_to_array((0, v.useState)(!0), 2),
                    N = O[0],
                    S = O[1],
                    E = _sliced_to_array((0, v.useState)(!1), 2),
                    T = E[0],
                    P = E[1],
                    Z = _sliced_to_array((0, v.useState)(null), 2),
                    A = Z[0],
                    R = Z[1],
                    F = (0, c.useEmitter)(),
                    M = F.subEvent,
                    I = F.offEvent,
                    q = (0, h.l)().runGBTest,
                    D = (0, d.Kp)(["isIosApp"]).isIosApp,
                    V = (0, v.useCallback)(function(e) {
                        null == e || e.preventDefault();
                        var r = o.current.value,
                            a = k(_.current);
                    ...
                    W = (0, v.useCallback)(function(e) {
                        ...
                        i.current = r, clearTimeout(f.current), f.current = setTimeout(function() {
                    ...
                    K = (0, v.useCallback)(function(e) {
                        _.current = e, i.current.length > 0 ? setTimeout(function() {
                            V()
                    ...
                    L = (0, v.useCallback)(function(e) {
                        if (o.current = e, null !== e) {
                            var r, t = w(s.pathname);
                            void 0 !== t && (_.current = t.key);
                            var a = (null === (r = s.query) || void 0 === r ? void 0 : r.q) || "";
                            e.value !== a && (e.value = a, i.current = a, setTimeout(function() {
                                (0, v.startTransition)(function() {
                                    C(a)
                                })
                            }, 0))
                ...
                (0, v.useEffect)(function() {
                    if (!r) return S(!1), void setTimeout(function() {
                        var e, r;
                    ...
                    var e = 0;
                    return function r() {
                            (!o.current || document.activeElement !== o.current) && (e += 1, o.current && document.activeElement !== o.current ? (o.current.focus(), document.activeElement !== o.current && e < 20 && setTimeout(r, 100)) : e < 20 && setTimeout(r, 100))
                        }(),
                        function() {
                    ...
                    var e;
                    if (r && !A) {
                        var t = null === (e = q("test_autocomplete_service")) || void 0 === e ? void 0 : e.value;
                        R(t)
                    }
                }, [A, r, q, R]), (0, v.useEffect)(function() {
                    return M("search-focus", U, {
                            autoOff: !1
                        }),
                        function() {
                            I("search-focus", U)
                        ...
                        children: [(0, a.jsx)("button", {
                            ...
                            children: [(0, a.jsx)("form", {
                                ...
                                children: (0, a.jsx)("input", {
                                    ...
                                    ref: L,
                                    autoComplete: "off",
                                    className: (0, n.Z)(l()["search-modal__header-box-input"], _define_property({}, l()["search-modal__header-box-input--ios"], D)),
                                    onChange: W
                                })
                            }), (0, a.jsxs)("button", {
